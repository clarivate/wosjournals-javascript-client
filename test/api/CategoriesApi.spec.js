...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoriesApi();
  });
  ...
  describe('CategoriesApi', function() {
    ...
    describe('categoriesIdCitedYearYearGet', function() {
      it('should call categoriesIdCitedYearYearGet successfully', function(done) {
        //uncomment below and update the code to test categoriesIdCitedYearYearGet
        //instance.categoriesIdCitedYearYearGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('categoriesIdCitingYearYearGet', function() {
      it('should call categoriesIdCitingYearYearGet successfully', function(done) {
        //uncomment below and update the code to test categoriesIdCitingYearYearGet
        //instance.categoriesIdCitingYearYearGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('categoriesIdReportsYearYearGet', function() {
      it('should call categoriesIdReportsYearYearGet successfully', function(done) {
        //uncomment below and update the code to test categoriesIdReportsYearYearGet
        //instance.categoriesIdReportsYearYearGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
