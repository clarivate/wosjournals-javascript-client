...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalsApi();
  });
  ...
  describe('JournalsApi', function() {
    ...
    describe('journalsIdCitedYearYearGet', function() {
      it('should call journalsIdCitedYearYearGet successfully', function(done) {
        //uncomment below and update the code to test journalsIdCitedYearYearGet
        //instance.journalsIdCitedYearYearGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('journalsIdCitingYearYearGet', function() {
      it('should call journalsIdCitingYearYearGet successfully', function(done) {
        //uncomment below and update the code to test journalsIdCitingYearYearGet
        //instance.journalsIdCitingYearYearGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('journalsIdHistoryGet', function() {
      it('should call journalsIdHistoryGet successfully', function(done) {
        //uncomment below and update the code to test journalsIdHistoryGet
        //instance.journalsIdHistoryGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('journalsIdReportsYearYearGet', function() {
      it('should call journalsIdReportsYearYearGet successfully', function(done) {
        //uncomment below and update the code to test journalsIdReportsYearYearGet
        //instance.journalsIdReportsYearYearGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
