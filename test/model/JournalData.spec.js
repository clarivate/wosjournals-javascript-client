...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalData();
  });
  ...
  describe('JournalData', function() {
    it('should create an instance of JournalData', function() {
      // uncomment below and update the code to test JournalData
      //var instane = new WebOfScienceJournalsApi.JournalData();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalData);
    });

    it('should have the property cited (base name: "cited")', function() {
      // uncomment below and update the code to test the property cited
      //var instance = new WebOfScienceJournalsApi.JournalData();
      //expect(instance).to.be();
    });

    it('should have the property citing (base name: "citing")', function() {
      // uncomment below and update the code to test the property citing
      //var instance = new WebOfScienceJournalsApi.JournalData();
      //expect(instance).to.be();
    });
