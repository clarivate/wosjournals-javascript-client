...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalData();
  });
  ...
  describe('JournalData', function() {
    it('should create an instance of JournalData', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalData();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalData);
    });
