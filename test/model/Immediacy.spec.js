...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.Immediacy();
  });
  ...
  describe('Immediacy', function() {
    it('should create an instance of Immediacy', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.Immediacy();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.Immediacy);
    });
