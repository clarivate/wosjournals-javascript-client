...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.Immediacy();
  });
  ...
  describe('Immediacy', function() {
    it('should create an instance of Immediacy', function() {
      // uncomment below and update the code to test Immediacy
      //var instane = new WebOfScienceJournalsApi.Immediacy();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.Immediacy);
    });

    it('should have the property count (base name: "count")', function() {
      // uncomment below and update the code to test the property count
      //var instance = new WebOfScienceJournalsApi.Immediacy();
      //expect(instance).to.be();
    });

    it('should have the property citesCurrentYear (base name: "citesCurrentYear")', function() {
      // uncomment below and update the code to test the property citesCurrentYear
      //var instance = new WebOfScienceJournalsApi.Immediacy();
      //expect(instance).to.be();
    });

    it('should have the property publishedCurrentYear (base name: "publishedCurrentYear")', function() {
      // uncomment below and update the code to test the property publishedCurrentYear
      //var instance = new WebOfScienceJournalsApi.Immediacy();
      //expect(instance).to.be();
    });
