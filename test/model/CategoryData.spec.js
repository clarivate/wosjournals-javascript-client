...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoryData();
  });
  ...
  describe('CategoryData', function() {
    it('should create an instance of CategoryData', function() {
      ...
      //var instane = new WebOfScienceJournalsApi.CategoryData();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoryData);
    });

    it('should have the property cited (base name: "cited")', function() {
      // uncomment below and update the code to test the property cited
      //var instance = new WebOfScienceJournalsApi.CategoryData();
