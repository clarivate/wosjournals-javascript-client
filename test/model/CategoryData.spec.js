...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoryData();
  });
  ...
  describe('CategoryData', function() {
    it('should create an instance of CategoryData', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoryData();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoryData);
    });
