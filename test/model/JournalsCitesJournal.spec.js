...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalsCitesJournal();
  });
  ...
  describe('JournalsCitesJournal', function() {
    it('should create an instance of JournalsCitesJournal', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalsCitesJournal();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalsCitesJournal);
    });
