...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalsCitesJournal();
  });
  ...
  describe('JournalsCitesJournal', function() {
    it('should create an instance of JournalsCitesJournal', function() {
      // uncomment below and update the code to test JournalsCitesJournal
      //var instane = new WebOfScienceJournalsApi.JournalsCitesJournal();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalsCitesJournal);
    });

    it('should have the property self (base name: "self")', function() {
      // uncomment below and update the code to test the property self
      //var instance = new WebOfScienceJournalsApi.JournalsCitesJournal();
