...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalListRecordRanks();
  });
  ...
  describe('JournalListRecordRanks', function() {
    it('should create an instance of JournalListRecordRanks', function() {
      // uncomment below and update the code to test JournalListRecordRanks
      //var instance = new ClarivateWosJournalsJsClient.JournalListRecordRanks();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalListRecordRanks);
    });
