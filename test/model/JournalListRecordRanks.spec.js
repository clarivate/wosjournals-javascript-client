...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalListRecordRanks();
  });
  ...
  describe('JournalListRecordRanks', function() {
    it('should create an instance of JournalListRecordRanks', function() {
      ...
      //var instane = new WebOfScienceJournalsApi.JournalListRecordRanks();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalListRecordRanks);
    });

    it('should have the property jif (base name: "jif")', function() {
      // uncomment below and update the code to test the property jif
      //var instance = new WebOfScienceJournalsApi.JournalListRecordRanks();
