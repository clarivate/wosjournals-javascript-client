...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.RankQuartileData();
  });
  ...
  describe('RankQuartileData', function() {
    it('should create an instance of RankQuartileData', function() {
      // uncomment below and update the code to test RankQuartileData
      //var instance = new ClarivateWosJournalsJsClient.RankQuartileData();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.RankQuartileData);
    });
