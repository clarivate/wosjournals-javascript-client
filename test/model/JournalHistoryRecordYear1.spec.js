...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordYear1();
  });
  ...
  describe('JournalHistoryRecordYear1', function() {
    it('should create an instance of JournalHistoryRecordYear1', function() {
      // uncomment below and update the code to test JournalHistoryRecordYear1
      //var instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordYear1();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalHistoryRecordYear1);
    });
