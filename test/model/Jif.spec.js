...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.Jif();
  });
  ...
  describe('Jif', function() {
    it('should create an instance of Jif', function() {
      // uncomment below and update the code to test Jif
      //var instane = new WebOfScienceJournalsApi.Jif();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.Jif);
    });
    ...
    it('should have the property median (base name: "median")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.Jif();
