...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.Jif();
  });
  ...
  describe('Jif', function() {
    it('should create an instance of Jif', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.Jif();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.Jif);
    });
