...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.OpenAccess();
  });
  ...
  describe('OpenAccess', function() {
    it('should create an instance of OpenAccess', function() {
      // uncomment below and update the code to test OpenAccess
      //var instane = new WebOfScienceJournalsApi.OpenAccess();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.OpenAccess);
    });
    ...
    it('should have the property startYear (base name: "startYear")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.OpenAccess();
