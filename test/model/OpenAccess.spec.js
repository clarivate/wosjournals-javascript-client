...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.OpenAccess();
  });
  ...
  describe('OpenAccess', function() {
    it('should create an instance of OpenAccess', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.OpenAccess();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.OpenAccess);
    });
