...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoryReportsSourceData();
  });
  ...
  describe('CategoryReportsSourceData', function() {
    it('should create an instance of CategoryReportsSourceData', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoryReportsSourceData();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoryReportsSourceData);
    });
