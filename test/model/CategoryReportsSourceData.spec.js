...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoryReportsSourceData();
  });
  ...
  describe('CategoryReportsSourceData', function() {
    it('should create an instance of CategoryReportsSourceData', function() {
      // uncomment below and update the code to test CategoryReportsSourceData
      //var instane = new WebOfScienceJournalsApi.CategoryReportsSourceData();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoryReportsSourceData);
    });
    ...
    it('should have the property articles (base name: "articles")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.CategoryReportsSourceData();
