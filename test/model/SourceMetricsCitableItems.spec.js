...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.SourceMetricsCitableItems();
  });
  ...
  describe('SourceMetricsCitableItems', function() {
    it('should create an instance of SourceMetricsCitableItems', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.SourceMetricsCitableItems();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.SourceMetricsCitableItems);
    });
