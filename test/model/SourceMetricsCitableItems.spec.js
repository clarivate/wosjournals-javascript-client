...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.SourceMetricsCitableItems();
  });
  ...
  describe('SourceMetricsCitableItems', function() {
    it('should create an instance of SourceMetricsCitableItems', function() {
      // uncomment below and update the code to test SourceMetricsCitableItems
      //var instane = new WebOfScienceJournalsApi.SourceMetricsCitableItems();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.SourceMetricsCitableItems);
    });

    it('should have the property total (base name: "total")', function() {
      // uncomment below and update the code to test the property total
      //var instance = new WebOfScienceJournalsApi.SourceMetricsCitableItems();
      //expect(instance).to.be();
    });

    it('should have the property articlesPercentage (base name: "articlesPercentage")', function() {
      // uncomment below and update the code to test the property articlesPercentage
      //var instance = new WebOfScienceJournalsApi.SourceMetricsCitableItems();
      //expect(instance).to.be();
    });
