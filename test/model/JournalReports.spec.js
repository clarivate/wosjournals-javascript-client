...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalReports();
  });
  ...
  describe('JournalReports', function() {
    it('should create an instance of JournalReports', function() {
      // uncomment below and update the code to test JournalReports
      //var instane = new WebOfScienceJournalsApi.JournalReports();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalReports);
    });

    it('should have the property year (base name: "year")', function() {
      // uncomment below and update the code to test the property year
      //var instance = new WebOfScienceJournalsApi.JournalReports();
    ...
    it('should have the property journalData (base name: "journalData")', function() {
      // uncomment below and update the code to test the property journalData
      //var instance = new WebOfScienceJournalsApi.JournalReports();
      //expect(instance).to.be();
    });
    ...
    it('should have the property journalProfile (base name: "journalProfile")', function() {
      // uncomment below and update the code to test the property journalProfile
      //var instance = new WebOfScienceJournalsApi.JournalReports();
      //expect(instance).to.be();
    });
