...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalReports();
  });
  ...
  describe('JournalReports', function() {
    it('should create an instance of JournalReports', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalReports();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalReports);
    });
