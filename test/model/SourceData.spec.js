...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.SourceData();
  });
  ...
  describe('SourceData', function() {
    it('should create an instance of SourceData', function() {
      // uncomment below and update the code to test SourceData
      //var instane = new WebOfScienceJournalsApi.SourceData();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.SourceData);
    });
    ...
    it('should have the property articles (base name: "articles")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.SourceData();
