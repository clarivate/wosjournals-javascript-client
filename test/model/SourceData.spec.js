...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.SourceData();
  });
  ...
  describe('SourceData', function() {
    it('should create an instance of SourceData', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.SourceData();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.SourceData);
    });
