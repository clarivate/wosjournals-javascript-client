...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoriesCitingJournal();
  });
  ...
  describe('CategoriesCitingJournal', function() {
    it('should create an instance of CategoriesCitingJournal', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoriesCitingJournal();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoriesCitingJournal);
    });
