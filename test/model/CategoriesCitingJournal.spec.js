...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoriesCitingJournal();
  });
  ...
  describe('CategoriesCitingJournal', function() {
    it('should create an instance of CategoriesCitingJournal', function() {
      // uncomment below and update the code to test CategoriesCitingJournal
      //var instane = new WebOfScienceJournalsApi.CategoriesCitingJournal();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoriesCitingJournal);
    });

    it('should have the property self (base name: "self")', function() {
      // uncomment below and update the code to test the property self
      //var instance = new WebOfScienceJournalsApi.CategoriesCitingJournal();
    ...
    it('should have the property citingJournals (base name: "citingJournals")', function() {
      // uncomment below and update the code to test the property citingJournals
      //var instance = new WebOfScienceJournalsApi.CategoriesCitingJournal();
      //expect(instance).to.be();
    });
