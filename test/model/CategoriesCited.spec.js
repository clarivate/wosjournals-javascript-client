...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoriesCited();
  });
  ...
  describe('CategoriesCited', function() {
    it('should create an instance of CategoriesCited', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoriesCited();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoriesCited);
    });
