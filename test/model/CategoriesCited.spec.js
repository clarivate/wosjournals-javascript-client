...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoriesCited();
  });
  ...
  describe('CategoriesCited', function() {
    it('should create an instance of CategoriesCited', function() {
      // uncomment below and update the code to test CategoriesCited
      //var instane = new WebOfScienceJournalsApi.CategoriesCited();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoriesCited);
    });

    it('should have the property metadata (base name: "metadata")', function() {
      // uncomment below and update the code to test the property metadata
      //var instance = new WebOfScienceJournalsApi.CategoriesCited();
