...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordYear();
  });
  ...
  describe('JournalHistoryRecordYear', function() {
    it('should create an instance of JournalHistoryRecordYear', function() {
      // uncomment below and update the code to test JournalHistoryRecordYear
      //var instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordYear();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalHistoryRecordYear);
    });
