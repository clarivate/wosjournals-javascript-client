...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoryReportsJournals();
  });
  ...
  describe('CategoryReportsJournals', function() {
    it('should create an instance of CategoryReportsJournals', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoryReportsJournals();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoryReportsJournals);
    });
