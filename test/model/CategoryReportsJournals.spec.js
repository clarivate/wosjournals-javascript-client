...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoryReportsJournals();
  });
  ...
  describe('CategoryReportsJournals', function() {
    it('should create an instance of CategoryReportsJournals', function() {
      // uncomment below and update the code to test CategoryReportsJournals
      //var instane = new WebOfScienceJournalsApi.CategoryReportsJournals();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoryReportsJournals);
    });

    it('should have the property count (base name: "count")', function() {
      // uncomment below and update the code to test the property count
      //var instance = new WebOfScienceJournalsApi.CategoryReportsJournals();
