...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.InfluenceMetrics();
  });
  ...
  describe('InfluenceMetrics', function() {
    it('should create an instance of InfluenceMetrics', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.InfluenceMetrics();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.InfluenceMetrics);
    });
