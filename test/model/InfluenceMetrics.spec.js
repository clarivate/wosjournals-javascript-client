...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.InfluenceMetrics();
  });
  ...
  describe('InfluenceMetrics', function() {
    it('should create an instance of InfluenceMetrics', function() {
      // uncomment below and update the code to test InfluenceMetrics
      //var instane = new WebOfScienceJournalsApi.InfluenceMetrics();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.InfluenceMetrics);
    });

    it('should have the property eigenFactor (base name: "eigenFactor")', function() {
      // uncomment below and update the code to test the property eigenFactor
      //var instance = new WebOfScienceJournalsApi.InfluenceMetrics();
