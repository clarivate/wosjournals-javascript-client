...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoryReports();
  });
  ...
  describe('CategoryReports', function() {
    it('should create an instance of CategoryReports', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoryReports();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoryReports);
    });
