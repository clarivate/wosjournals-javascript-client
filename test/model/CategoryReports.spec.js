...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoryReports();
  });
  ...
  describe('CategoryReports', function() {
    it('should create an instance of CategoryReports', function() {
      // uncomment below and update the code to test CategoryReports
      //var instane = new WebOfScienceJournalsApi.CategoryReports();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoryReports);
    });

    it('should have the property year (base name: "year")', function() {
      // uncomment below and update the code to test the property year
      //var instance = new WebOfScienceJournalsApi.CategoryReports();
    ...
    it('should have the property cites (base name: "cites")', function() {
      // uncomment below and update the code to test the property cites
      //var instance = new WebOfScienceJournalsApi.CategoryReports();
      //expect(instance).to.be();
    });
    ...
    it('should have the property immediacy (base name: "immediacy")', function() {
      // uncomment below and update the code to test the property immediacy
      //var instance = new WebOfScienceJournalsApi.CategoryReports();
      //expect(instance).to.be();
    });

    it('should have the property halfLife (base name: "halfLife")', function() {
      // uncomment below and update the code to test the property halfLife
      //var instance = new WebOfScienceJournalsApi.CategoryReports();
      //expect(instance).to.be();
    });
