...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.HalfLife();
  });
  ...
  describe('HalfLife', function() {
    it('should create an instance of HalfLife', function() {
      // uncomment below and update the code to test HalfLife
      //var instane = new WebOfScienceJournalsApi.HalfLife();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.HalfLife);
    });

    it('should have the property cited (base name: "cited")', function() {
      // uncomment below and update the code to test the property cited
      //var instance = new WebOfScienceJournalsApi.HalfLife();
