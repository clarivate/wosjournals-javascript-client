...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.HalfLife();
  });
  ...
  describe('HalfLife', function() {
    it('should create an instance of HalfLife', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.HalfLife();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.HalfLife);
    });
