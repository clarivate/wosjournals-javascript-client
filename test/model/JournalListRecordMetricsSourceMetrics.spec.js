...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalListRecordMetricsSourceMetrics();
  });
  ...
  describe('JournalListRecordMetricsSourceMetrics', function() {
    it('should create an instance of JournalListRecordMetricsSourceMetrics', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalListRecordMetricsSourceMetrics();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalListRecordMetricsSourceMetrics);
    });
