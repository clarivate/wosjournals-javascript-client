...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalListRecordMetricsSourceMetrics();
  });
  ...
  describe('JournalListRecordMetricsSourceMetrics', function() {
    it('should create an instance of JournalListRecordMetricsSourceMetrics', function() {
      // uncomment below and update the code to test JournalListRecordMetricsSourceMetrics
      //var instane = new WebOfScienceJournalsApi.JournalListRecordMetricsSourceMetrics();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalListRecordMetricsSourceMetrics);
    });
    ...
    it('should have the property jifPercentile (base name: "jifPercentile")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.JournalListRecordMetricsSourceMetrics();
