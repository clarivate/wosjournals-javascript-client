...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalListRecord();
  });
  ...
  describe('JournalListRecord', function() {
    it('should create an instance of JournalListRecord', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalListRecord();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalListRecord);
    });
