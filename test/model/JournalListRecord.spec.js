...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalListRecord();
  });
  ...
  describe('JournalListRecord', function() {
    it('should create an instance of JournalListRecord', function() {
      // uncomment below and update the code to test JournalListRecord
      //var instane = new WebOfScienceJournalsApi.JournalListRecord();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalListRecord);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new WebOfScienceJournalsApi.JournalListRecord();
