...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoryList();
  });
  ...
  describe('CategoryList', function() {
    it('should create an instance of CategoryList', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoryList();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoryList);
    });
