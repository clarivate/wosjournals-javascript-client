...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoryList();
  });
  ...
  describe('CategoryList', function() {
    it('should create an instance of CategoryList', function() {
      ...
      //var instane = new WebOfScienceJournalsApi.CategoryList();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoryList);
    });

    it('should have the property metadata (base name: "metadata")', function() {
      // uncomment below and update the code to test the property metadata
      //var instance = new WebOfScienceJournalsApi.CategoryList();
