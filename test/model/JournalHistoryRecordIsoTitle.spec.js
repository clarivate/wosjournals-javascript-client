...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordIsoTitle();
  });
  ...
  describe('JournalHistoryRecordIsoTitle', function() {
    it('should create an instance of JournalHistoryRecordIsoTitle', function() {
      // uncomment below and update the code to test JournalHistoryRecordIsoTitle
      //var instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordIsoTitle();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalHistoryRecordIsoTitle);
    });
