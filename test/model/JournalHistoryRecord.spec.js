...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalHistoryRecord();
  });
  ...
  describe('JournalHistoryRecord', function() {
    it('should create an instance of JournalHistoryRecord', function() {
      // uncomment below and update the code to test JournalHistoryRecord
      //var instance = new ClarivateWosJournalsJsClient.JournalHistoryRecord();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalHistoryRecord);
    });
