...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.InfluenceMetricsEigenFactor();
  });
  ...
  describe('InfluenceMetricsEigenFactor', function() {
    it('should create an instance of InfluenceMetricsEigenFactor', function() {
      // uncomment below and update the code to test InfluenceMetricsEigenFactor
      //var instane = new WebOfScienceJournalsApi.InfluenceMetricsEigenFactor();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.InfluenceMetricsEigenFactor);
    });

    it('should have the property score (base name: "score")', function() {
      // uncomment below and update the code to test the property score
      //var instance = new WebOfScienceJournalsApi.InfluenceMetricsEigenFactor();
