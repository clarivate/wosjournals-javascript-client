...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.InfluenceMetricsEigenFactor();
  });
  ...
  describe('InfluenceMetricsEigenFactor', function() {
    it('should create an instance of InfluenceMetricsEigenFactor', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.InfluenceMetricsEigenFactor();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.InfluenceMetricsEigenFactor);
    });
