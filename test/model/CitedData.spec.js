...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CitedData();
  });
  ...
  describe('CitedData', function() {
    it('should create an instance of CitedData', function() {
      // uncomment below and update the code to test CitedData
      //var instane = new WebOfScienceJournalsApi.CitedData();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CitedData);
    });

    it('should have the property url (base name: "url")', function() {
      // uncomment below and update the code to test the property url
      //var instance = new WebOfScienceJournalsApi.CitedData();
