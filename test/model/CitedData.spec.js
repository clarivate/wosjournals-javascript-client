...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CitedData();
  });
  ...
  describe('CitedData', function() {
    it('should create an instance of CitedData', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CitedData();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CitedData);
    });
