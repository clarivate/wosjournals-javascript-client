...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalsCited();
  });
  ...
  describe('JournalsCited', function() {
    it('should create an instance of JournalsCited', function() {
      // uncomment below and update the code to test JournalsCited
      //var instane = new WebOfScienceJournalsApi.JournalsCited();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalsCited);
    });

    it('should have the property metadata (base name: "metadata")', function() {
      // uncomment below and update the code to test the property metadata
      //var instance = new WebOfScienceJournalsApi.JournalsCited();
