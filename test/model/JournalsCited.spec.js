...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalsCited();
  });
  ...
  describe('JournalsCited', function() {
    it('should create an instance of JournalsCited', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalsCited();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalsCited);
    });
