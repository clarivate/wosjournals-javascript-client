...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordPublisher();
  });
  ...
  describe('JournalHistoryRecordPublisher', function() {
    it('should create an instance of JournalHistoryRecordPublisher', function() {
      // uncomment below and update the code to test JournalHistoryRecordPublisher
      //var instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordPublisher();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalHistoryRecordPublisher);
    });
