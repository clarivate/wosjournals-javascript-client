...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.SourceDataArticles();
  });
  ...
  describe('SourceDataArticles', function() {
    it('should create an instance of SourceDataArticles', function() {
      // uncomment below and update the code to test SourceDataArticles
      //var instane = new WebOfScienceJournalsApi.SourceDataArticles();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.SourceDataArticles);
    });

    it('should have the property count (base name: "count")', function() {
      // uncomment below and update the code to test the property count
      //var instance = new WebOfScienceJournalsApi.SourceDataArticles();
