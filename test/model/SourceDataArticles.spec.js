...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.SourceDataArticles();
  });
  ...
  describe('SourceDataArticles', function() {
    it('should create an instance of SourceDataArticles', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.SourceDataArticles();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.SourceDataArticles);
    });
