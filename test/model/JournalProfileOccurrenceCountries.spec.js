...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalProfileOccurrenceCountries();
  });
  ...
  describe('JournalProfileOccurrenceCountries', function() {
    it('should create an instance of JournalProfileOccurrenceCountries', function() {
      // uncomment below and update the code to test JournalProfileOccurrenceCountries
      //var instane = new WebOfScienceJournalsApi.JournalProfileOccurrenceCountries();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalProfileOccurrenceCountries);
    });
    ...
    it('should have the property countryRegion (base name: "countryRegion")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.JournalProfileOccurrenceCountries();
