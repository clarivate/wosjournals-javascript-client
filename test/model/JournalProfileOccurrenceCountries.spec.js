...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalProfileOccurrenceCountries();
  });
  ...
  describe('JournalProfileOccurrenceCountries', function() {
    it('should create an instance of JournalProfileOccurrenceCountries', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalProfileOccurrenceCountries();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalProfileOccurrenceCountries);
    });
