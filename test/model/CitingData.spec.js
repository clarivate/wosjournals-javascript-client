...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CitingData();
  });
  ...
  describe('CitingData', function() {
    it('should create an instance of CitingData', function() {
      // uncomment below and update the code to test CitingData
      //var instane = new WebOfScienceJournalsApi.CitingData();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CitingData);
    });

    it('should have the property url (base name: "url")', function() {
      // uncomment below and update the code to test the property url
      //var instance = new WebOfScienceJournalsApi.CitingData();
