...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CitingData();
  });
  ...
  describe('CitingData', function() {
    it('should create an instance of CitingData', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CitingData();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CitingData);
    });
