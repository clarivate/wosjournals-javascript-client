...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoriesCitingHits();
  });
  ...
  describe('CategoriesCitingHits', function() {
    it('should create an instance of CategoriesCitingHits', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoriesCitingHits();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoriesCitingHits);
    });
