...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoriesCitingHits();
  });
  ...
  describe('CategoriesCitingHits', function() {
    it('should create an instance of CategoriesCitingHits', function() {
      // uncomment below and update the code to test CategoriesCitingHits
      //var instane = new WebOfScienceJournalsApi.CategoriesCitingHits();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoriesCitingHits);
    });
    ...
    it('should have the property journal (base name: "journal")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.CategoriesCitingHits();
