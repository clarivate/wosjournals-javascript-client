...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.Ranks();
  });
  ...
  describe('Ranks', function() {
    it('should create an instance of Ranks', function() {
      // uncomment below and update the code to test Ranks
      //var instance = new ClarivateWosJournalsJsClient.Ranks();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.Ranks);
    });
    ...
    it('should have the property articleInfluence (base name: "articleInfluence")', function() {
      // uncomment below and update the code to test the property articleInfluence
      //var instance = new ClarivateWosJournalsJsClient.Ranks();
      //expect(instance).to.be();
    });

    it('should have the property eigenFactorScore (base name: "eigenFactorScore")', function() {
      // uncomment below and update the code to test the property eigenFactorScore
      //var instance = new ClarivateWosJournalsJsClient.Ranks();
      //expect(instance).to.be();
    });
    ...
    it('should have the property esiCitations (base name: "esiCitations")', function() {
      // uncomment below and update the code to test the property esiCitations
      //var instance = new ClarivateWosJournalsJsClient.Ranks();
      //expect(instance).to.be();
    });
