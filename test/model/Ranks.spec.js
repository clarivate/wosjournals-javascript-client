...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.Ranks();
  });
  ...
  describe('Ranks', function() {
    it('should create an instance of Ranks', function() {
      ...
      //var instane = new WebOfScienceJournalsApi.Ranks();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.Ranks);
    });

    it('should have the property jif (base name: "jif")', function() {
      // uncomment below and update the code to test the property jif
      //var instance = new WebOfScienceJournalsApi.Ranks();
