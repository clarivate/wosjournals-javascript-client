...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.SourceMetrics();
  });
  ...
  describe('SourceMetrics', function() {
    it('should create an instance of SourceMetrics', function() {
      // uncomment below and update the code to test SourceMetrics
      //var instane = new WebOfScienceJournalsApi.SourceMetrics();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.SourceMetrics);
    });
    ...
    it('should have the property citableItems (base name: "citableItems")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.SourceMetrics();
      //expect(instance).to.be();
    });

    it('should have the property jifPercentile (base name: "jifPercentile")', function() {
      // uncomment below and update the code to test the property jifPercentile
      //var instance = new WebOfScienceJournalsApi.SourceMetrics();
      //expect(instance).to.be();
    });
