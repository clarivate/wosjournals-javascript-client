...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.SourceMetrics();
  });
  ...
  describe('SourceMetrics', function() {
    it('should create an instance of SourceMetrics', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.SourceMetrics();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.SourceMetrics);
    });
