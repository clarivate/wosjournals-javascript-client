...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.WebOfScienceJournalsApi);
  }
}(this, function(expect, WebOfScienceJournalsApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.Frequency();
  });
  ...
  describe('Frequency', function() {
    it('should create an instance of Frequency', function() {
      ...
      //var instane = new WebOfScienceJournalsApi.Frequency();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.Frequency);
    });

    it('should have the property annual (base name: "annual")', function() {
      // uncomment below and update the code to test the property annual
      //var instance = new WebOfScienceJournalsApi.Frequency();
      //expect(instance).to.be();
    });

    it('should have the property hemiannual (base name: "hemiannual")', function() {
      // uncomment below and update the code to test the property hemiannual
      //var instance = new WebOfScienceJournalsApi.Frequency();
      //expect(instance).to.be();
    });

    it('should have the property triannual (base name: "triannual")', function() {
      // uncomment below and update the code to test the property triannual
      //var instance = new WebOfScienceJournalsApi.Frequency();
      //expect(instance).to.be();
    });

    it('should have the property semiannual (base name: "semiannual")', function() {
      // uncomment below and update the code to test the property semiannual
      //var instance = new WebOfScienceJournalsApi.Frequency();
      //expect(instance).to.be();
    });

    it('should have the property quarterly (base name: "quarterly")', function() {
      // uncomment below and update the code to test the property quarterly
      //var instance = new WebOfScienceJournalsApi.Frequency();
      //expect(instance).to.be();
    });

    it('should have the property bimonthly (base name: "bimonthly")', function() {
      // uncomment below and update the code to test the property bimonthly
      //var instance = new WebOfScienceJournalsApi.Frequency();
      //expect(instance).to.be();
    });
    ...
    it('should have the property biweekly (base name: "biweekly")', function() {
      // uncomment below and update the code to test the property biweekly
      //var instance = new WebOfScienceJournalsApi.Frequency();
      //expect(instance).to.be();
    });
    ...
    it('should have the property irregular (base name: "irregular")', function() {
      // uncomment below and update the code to test the property irregular
      //var instance = new WebOfScienceJournalsApi.Frequency();
      //expect(instance).to.be();
    });
