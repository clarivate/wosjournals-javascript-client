...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.ClarivateWosJournalsJsClient);
  }
}(this, function(expect, ClarivateWosJournalsJsClient) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.Frequency();
  });
  ...
  describe('Frequency', function() {
    it('should create an instance of Frequency', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.Frequency();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.Frequency);
    });
