...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoryReportsSourceDataArticles();
  });
  ...
  describe('CategoryReportsSourceDataArticles', function() {
    it('should create an instance of CategoryReportsSourceDataArticles', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoryReportsSourceDataArticles();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoryReportsSourceDataArticles);
    });
