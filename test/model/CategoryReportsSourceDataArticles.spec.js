...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoryReportsSourceDataArticles();
  });
  ...
  describe('CategoryReportsSourceDataArticles', function() {
    it('should create an instance of CategoryReportsSourceDataArticles', function() {
      // uncomment below and update the code to test CategoryReportsSourceDataArticles
      //var instane = new WebOfScienceJournalsApi.CategoryReportsSourceDataArticles();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoryReportsSourceDataArticles);
    });

    it('should have the property count (base name: "count")', function() {
      // uncomment below and update the code to test the property count
      //var instance = new WebOfScienceJournalsApi.CategoryReportsSourceDataArticles();
