...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoriesCiting();
  });
  ...
  describe('CategoriesCiting', function() {
    it('should create an instance of CategoriesCiting', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoriesCiting();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoriesCiting);
    });
