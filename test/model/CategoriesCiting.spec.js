...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoriesCiting();
  });
  ...
  describe('CategoriesCiting', function() {
    it('should create an instance of CategoriesCiting', function() {
      // uncomment below and update the code to test CategoriesCiting
      //var instane = new WebOfScienceJournalsApi.CategoriesCiting();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoriesCiting);
    });

    it('should have the property metadata (base name: "metadata")', function() {
      // uncomment below and update the code to test the property metadata
      //var instance = new WebOfScienceJournalsApi.CategoriesCiting();
