...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalListRecordRanksJif();
  });
  ...
  describe('JournalListRecordRanksJif', function() {
    it('should create an instance of JournalListRecordRanksJif', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalListRecordRanksJif();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalListRecordRanksJif);
    });
