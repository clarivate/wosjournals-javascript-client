...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalListRecordRanksJif();
  });
  ...
  describe('JournalListRecordRanksJif', function() {
    it('should create an instance of JournalListRecordRanksJif', function() {
      // uncomment below and update the code to test JournalListRecordRanksJif
      //var instane = new WebOfScienceJournalsApi.JournalListRecordRanksJif();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalListRecordRanksJif);
    });

    it('should have the property category (base name: "category")', function() {
      // uncomment below and update the code to test the property category
      //var instance = new WebOfScienceJournalsApi.JournalListRecordRanksJif();
