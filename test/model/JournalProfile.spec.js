...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalProfile();
  });
  ...
  describe('JournalProfile', function() {
    it('should create an instance of JournalProfile', function() {
      // uncomment below and update the code to test JournalProfile
      //var instane = new WebOfScienceJournalsApi.JournalProfile();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalProfile);
    });
    ...
    it('should have the property startYear (base name: "startYear")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.JournalProfile();
    ...
    it('should have the property citableItems (base name: "citableItems")', function() {
      // uncomment below and update the code to test the property citableItems
      //var instance = new WebOfScienceJournalsApi.JournalProfile();
      //expect(instance).to.be();
    });
    ...
    it('should have the property occurrenceCountries (base name: "occurrenceCountries")', function() {
      // uncomment below and update the code to test the property occurrenceCountries
      //var instance = new WebOfScienceJournalsApi.JournalProfile();
      //expect(instance).to.be();
    });

    it('should have the property occurrenceOrganizations (base name: "occurrenceOrganizations")', function() {
      // uncomment below and update the code to test the property occurrenceOrganizations
      //var instance = new WebOfScienceJournalsApi.JournalProfile();
      //expect(instance).to.be();
    });
