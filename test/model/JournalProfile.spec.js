...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalProfile();
  });
  ...
  describe('JournalProfile', function() {
    it('should create an instance of JournalProfile', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalProfile();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalProfile);
    });
