...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalListRecordMetrics();
  });
  ...
  describe('JournalListRecordMetrics', function() {
    it('should create an instance of JournalListRecordMetrics', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalListRecordMetrics();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalListRecordMetrics);
    });
