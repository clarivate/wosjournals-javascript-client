...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalListRecordMetrics();
  });
  ...
  describe('JournalListRecordMetrics', function() {
    it('should create an instance of JournalListRecordMetrics', function() {
      // uncomment below and update the code to test JournalListRecordMetrics
      //var instane = new WebOfScienceJournalsApi.JournalListRecordMetrics();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalListRecordMetrics);
    });
    ...
    it('should have the property impactMetrics (base name: "impactMetrics")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.JournalListRecordMetrics();
