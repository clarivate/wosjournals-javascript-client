...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoryRecord();
  });
  ...
  describe('CategoryRecord', function() {
    it('should create an instance of CategoryRecord', function() {
      // uncomment below and update the code to test CategoryRecord
      //var instane = new WebOfScienceJournalsApi.CategoryRecord();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoryRecord);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new WebOfScienceJournalsApi.CategoryRecord();
