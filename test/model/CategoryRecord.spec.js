...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoryRecord();
  });
  ...
  describe('CategoryRecord', function() {
    it('should create an instance of CategoryRecord', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoryRecord();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoryRecord);
    });
