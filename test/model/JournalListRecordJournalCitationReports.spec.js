...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalListRecordJournalCitationReports();
  });
  ...
  describe('JournalListRecordJournalCitationReports', function() {
    it('should create an instance of JournalListRecordJournalCitationReports', function() {
      // uncomment below and update the code to test JournalListRecordJournalCitationReports
      //var instane = new WebOfScienceJournalsApi.JournalListRecordJournalCitationReports();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalListRecordJournalCitationReports);
    });

    it('should have the property year (base name: "year")', function() {
      // uncomment below and update the code to test the property year
      //var instance = new WebOfScienceJournalsApi.JournalListRecordJournalCitationReports();
