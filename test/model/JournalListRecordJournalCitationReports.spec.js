...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalListRecordJournalCitationReports();
  });
  ...
  describe('JournalListRecordJournalCitationReports', function() {
    it('should create an instance of JournalListRecordJournalCitationReports', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalListRecordJournalCitationReports();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalListRecordJournalCitationReports);
    });
