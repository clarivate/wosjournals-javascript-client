...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalProfileCitations();
  });
  ...
  describe('JournalProfileCitations', function() {
    it('should create an instance of JournalProfileCitations', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalProfileCitations();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalProfileCitations);
    });
