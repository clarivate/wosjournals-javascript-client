...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalProfileCitations();
  });
  ...
  describe('JournalProfileCitations', function() {
    it('should create an instance of JournalProfileCitations', function() {
      // uncomment below and update the code to test JournalProfileCitations
      //var instane = new WebOfScienceJournalsApi.JournalProfileCitations();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalProfileCitations);
    });
    ...
    it('should have the property goldOA (base name: "goldOA")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.JournalProfileCitations();
