...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalProfileCitableItems();
  });
  ...
  describe('JournalProfileCitableItems', function() {
    it('should create an instance of JournalProfileCitableItems', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalProfileCitableItems();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalProfileCitableItems);
    });
