...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalProfileCitableItems();
  });
  ...
  describe('JournalProfileCitableItems', function() {
    it('should create an instance of JournalProfileCitableItems', function() {
      // uncomment below and update the code to test JournalProfileCitableItems
      //var instane = new WebOfScienceJournalsApi.JournalProfileCitableItems();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalProfileCitableItems);
    });

    it('should have the property goldOA (base name: "goldOA")', function() {
      // uncomment below and update the code to test the property goldOA
      //var instance = new WebOfScienceJournalsApi.JournalProfileCitableItems();
