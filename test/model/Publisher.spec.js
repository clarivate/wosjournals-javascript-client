...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.Publisher();
  });
  ...
  describe('Publisher', function() {
    it('should create an instance of Publisher', function() {
      ...
      //var instane = new WebOfScienceJournalsApi.Publisher();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.Publisher);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new WebOfScienceJournalsApi.Publisher();
