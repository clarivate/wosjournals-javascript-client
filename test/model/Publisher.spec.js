...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.Publisher();
  });
  ...
  describe('Publisher', function() {
    it('should create an instance of Publisher', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.Publisher();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.Publisher);
    });
