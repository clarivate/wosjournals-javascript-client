...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoriesCitedHits();
  });
  ...
  describe('CategoriesCitedHits', function() {
    it('should create an instance of CategoriesCitedHits', function() {
      // uncomment below and update the code to test CategoriesCitedHits
      //var instane = new WebOfScienceJournalsApi.CategoriesCitedHits();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoriesCitedHits);
    });
    ...
    it('should have the property journal (base name: "journal")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.CategoriesCitedHits();
