...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoriesCitedHits();
  });
  ...
  describe('CategoriesCitedHits', function() {
    it('should create an instance of CategoriesCitedHits', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoriesCitedHits();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoriesCitedHits);
    });
