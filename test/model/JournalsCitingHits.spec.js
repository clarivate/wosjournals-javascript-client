...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalsCitingHits();
  });
  ...
  describe('JournalsCitingHits', function() {
    it('should create an instance of JournalsCitingHits', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalsCitingHits();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalsCitingHits);
    });
