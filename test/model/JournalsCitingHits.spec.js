...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalsCitingHits();
  });
  ...
  describe('JournalsCitingHits', function() {
    it('should create an instance of JournalsCitingHits', function() {
      // uncomment below and update the code to test JournalsCitingHits
      //var instane = new WebOfScienceJournalsApi.JournalsCitingHits();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalsCitingHits);
    });
    ...
    it('should have the property journal (base name: "journal")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.JournalsCitingHits();
