...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalsCitedHits();
  });
  ...
  describe('JournalsCitedHits', function() {
    it('should create an instance of JournalsCitedHits', function() {
      // uncomment below and update the code to test JournalsCitedHits
      //var instane = new WebOfScienceJournalsApi.JournalsCitedHits();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalsCitedHits);
    });
    ...
    it('should have the property journal (base name: "journal")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.JournalsCitedHits();
