...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalsCitedHits();
  });
  ...
  describe('JournalsCitedHits', function() {
    it('should create an instance of JournalsCitedHits', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalsCitedHits();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalsCitedHits);
    });
