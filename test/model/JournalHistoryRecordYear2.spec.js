...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordYear2();
  });
  ...
  describe('JournalHistoryRecordYear2', function() {
    it('should create an instance of JournalHistoryRecordYear2', function() {
      // uncomment below and update the code to test JournalHistoryRecordYear2
      //var instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordYear2();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalHistoryRecordYear2);
    });
