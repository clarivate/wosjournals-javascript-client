...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoryReportsSourceDataReviews();
  });
  ...
  describe('CategoryReportsSourceDataReviews', function() {
    it('should create an instance of CategoryReportsSourceDataReviews', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoryReportsSourceDataReviews();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoryReportsSourceDataReviews);
    });
