...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoryReportsSourceDataReviews();
  });
  ...
  describe('CategoryReportsSourceDataReviews', function() {
    it('should create an instance of CategoryReportsSourceDataReviews', function() {
      // uncomment below and update the code to test CategoryReportsSourceDataReviews
      //var instane = new WebOfScienceJournalsApi.CategoryReportsSourceDataReviews();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoryReportsSourceDataReviews);
    });

    it('should have the property count (base name: "count")', function() {
      // uncomment below and update the code to test the property count
      //var instance = new WebOfScienceJournalsApi.CategoryReportsSourceDataReviews();
