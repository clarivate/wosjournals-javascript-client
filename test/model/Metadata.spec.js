...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.Metadata();
  });
  ...
  describe('Metadata', function() {
    it('should create an instance of Metadata', function() {
      ...
      //var instane = new WebOfScienceJournalsApi.Metadata();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.Metadata);
    });

    it('should have the property total (base name: "total")', function() {
      // uncomment below and update the code to test the property total
      //var instance = new WebOfScienceJournalsApi.Metadata();
