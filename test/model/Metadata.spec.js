...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.Metadata();
  });
  ...
  describe('Metadata', function() {
    it('should create an instance of Metadata', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.Metadata();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.Metadata);
    });
