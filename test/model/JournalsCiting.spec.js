...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalsCiting();
  });
  ...
  describe('JournalsCiting', function() {
    it('should create an instance of JournalsCiting', function() {
      // uncomment below and update the code to test JournalsCiting
      //var instane = new WebOfScienceJournalsApi.JournalsCiting();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalsCiting);
    });

    it('should have the property metadata (base name: "metadata")', function() {
      // uncomment below and update the code to test the property metadata
      //var instance = new WebOfScienceJournalsApi.JournalsCiting();
