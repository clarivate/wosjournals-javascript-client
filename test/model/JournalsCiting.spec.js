...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalsCiting();
  });
  ...
  describe('JournalsCiting', function() {
    it('should create an instance of JournalsCiting', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalsCiting();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalsCiting);
    });
