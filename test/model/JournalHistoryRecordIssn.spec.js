...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordIssn();
  });
  ...
  describe('JournalHistoryRecordIssn', function() {
    it('should create an instance of JournalHistoryRecordIssn', function() {
      // uncomment below and update the code to test JournalHistoryRecordIssn
      //var instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordIssn();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalHistoryRecordIssn);
    });
