...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.RanksJif();
  });
  ...
  describe('RanksJif', function() {
    it('should create an instance of RanksJif', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.RanksJif();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.RanksJif);
    });
