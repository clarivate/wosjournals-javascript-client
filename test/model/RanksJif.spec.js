...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.RanksJif();
  });
  ...
  describe('RanksJif', function() {
    it('should create an instance of RanksJif', function() {
      // uncomment below and update the code to test RanksJif
      //var instane = new WebOfScienceJournalsApi.RanksJif();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.RanksJif);
    });

    it('should have the property category (base name: "category")', function() {
      // uncomment below and update the code to test the property category
      //var instance = new WebOfScienceJournalsApi.RanksJif();
