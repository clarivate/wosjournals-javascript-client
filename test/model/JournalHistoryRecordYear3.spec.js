...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordYear3();
  });
  ...
  describe('JournalHistoryRecordYear3', function() {
    it('should create an instance of JournalHistoryRecordYear3', function() {
      // uncomment below and update the code to test JournalHistoryRecordYear3
      //var instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordYear3();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalHistoryRecordYear3);
    });
