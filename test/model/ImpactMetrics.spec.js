...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.ImpactMetrics();
  });
  ...
  describe('ImpactMetrics', function() {
    it('should create an instance of ImpactMetrics', function() {
      ...
      //var instane = new WebOfScienceJournalsApi.ImpactMetrics();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.ImpactMetrics);
    });
    ...
    it('should have the property totalCites (base name: "totalCites")', function() {
      ...
      //var instance = new WebOfScienceJournalsApi.ImpactMetrics();
