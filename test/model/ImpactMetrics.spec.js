...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.ImpactMetrics();
  });
  ...
  describe('ImpactMetrics', function() {
    it('should create an instance of ImpactMetrics', function() {
      // uncomment below and update the code to test ImpactMetrics
      //var instance = new ClarivateWosJournalsJsClient.ImpactMetrics();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.ImpactMetrics);
    });

    it('should have the property totalCites (base name: "totalCites")', function() {
      // uncomment below and update the code to test the property totalCites
      //var instance = new ClarivateWosJournalsJsClient.ImpactMetrics();
      //expect(instance).to.be();
    });

    it('should have the property jif (base name: "jif")', function() {
      // uncomment below and update the code to test the property jif
      //var instance = new ClarivateWosJournalsJsClient.ImpactMetrics();
      //expect(instance).to.be();
    });

    it('should have the property jifWithoutSelfCitations (base name: "jifWithoutSelfCitations")', function() {
      // uncomment below and update the code to test the property jifWithoutSelfCitations
      //var instance = new ClarivateWosJournalsJsClient.ImpactMetrics();
      //expect(instance).to.be();
    });

    it('should have the property jif5Years (base name: "jif5Years")', function() {
      // uncomment below and update the code to test the property jif5Years
      //var instance = new ClarivateWosJournalsJsClient.ImpactMetrics();
      //expect(instance).to.be();
    });

    it('should have the property immediacyIndex (base name: "immediacyIndex")', function() {
      // uncomment below and update the code to test the property immediacyIndex
      //var instance = new ClarivateWosJournalsJsClient.ImpactMetrics();
      //expect(instance).to.be();
    });

    it('should have the property jci (base name: "jci")', function() {
      // uncomment below and update the code to test the property jci
      //var instance = new ClarivateWosJournalsJsClient.ImpactMetrics();
      //expect(instance).to.be();
    });
