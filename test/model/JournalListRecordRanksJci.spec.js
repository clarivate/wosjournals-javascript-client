...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalListRecordRanksJci();
  });
  ...
  describe('JournalListRecordRanksJci', function() {
    it('should create an instance of JournalListRecordRanksJci', function() {
      // uncomment below and update the code to test JournalListRecordRanksJci
      //var instance = new ClarivateWosJournalsJsClient.JournalListRecordRanksJci();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalListRecordRanksJci);
    });
    ...
    it('should have the property jciPercentile (base name: "jciPercentile")', function() {
      // uncomment below and update the code to test the property jciPercentile
      //var instance = new ClarivateWosJournalsJsClient.JournalListRecordRanksJci();
      //expect(instance).to.be();
    });
