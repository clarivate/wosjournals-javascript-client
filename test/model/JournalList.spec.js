...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalList();
  });
  ...
  describe('JournalList', function() {
    it('should create an instance of JournalList', function() {
      // uncomment below and update the code to test JournalList
      //var instane = new WebOfScienceJournalsApi.JournalList();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalList);
    });

    it('should have the property metadata (base name: "metadata")', function() {
      // uncomment below and update the code to test the property metadata
      //var instance = new WebOfScienceJournalsApi.JournalList();
