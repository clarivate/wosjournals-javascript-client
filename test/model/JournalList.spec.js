...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalList();
  });
  ...
  describe('JournalList', function() {
    it('should create an instance of JournalList', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalList();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalList);
    });
