...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalListRecordMetricsImpactMetrics();
  });
  ...
  describe('JournalListRecordMetricsImpactMetrics', function() {
    it('should create an instance of JournalListRecordMetricsImpactMetrics', function() {
      // uncomment below and update the code to test JournalListRecordMetricsImpactMetrics
      //var instance = new ClarivateWosJournalsJsClient.JournalListRecordMetricsImpactMetrics();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalListRecordMetricsImpactMetrics);
    });
