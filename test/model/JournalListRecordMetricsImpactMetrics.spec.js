...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalListRecordMetricsImpactMetrics();
  });
  ...
  describe('JournalListRecordMetricsImpactMetrics', function() {
    it('should create an instance of JournalListRecordMetricsImpactMetrics', function() {
      ...
      //var instane = new WebOfScienceJournalsApi.JournalListRecordMetricsImpactMetrics();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalListRecordMetricsImpactMetrics);
    });

    it('should have the property jif (base name: "jif")', function() {
      // uncomment below and update the code to test the property jif
      //var instance = new WebOfScienceJournalsApi.JournalListRecordMetricsImpactMetrics();
