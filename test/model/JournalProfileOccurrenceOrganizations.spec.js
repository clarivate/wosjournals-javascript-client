...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalProfileOccurrenceOrganizations();
  });
  ...
  describe('JournalProfileOccurrenceOrganizations', function() {
    it('should create an instance of JournalProfileOccurrenceOrganizations', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalProfileOccurrenceOrganizations();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalProfileOccurrenceOrganizations);
    });
