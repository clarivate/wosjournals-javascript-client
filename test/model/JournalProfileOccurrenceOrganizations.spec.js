...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalProfileOccurrenceOrganizations();
  });
  ...
  describe('JournalProfileOccurrenceOrganizations', function() {
    it('should create an instance of JournalProfileOccurrenceOrganizations', function() {
      // uncomment below and update the code to test JournalProfileOccurrenceOrganizations
      //var instane = new WebOfScienceJournalsApi.JournalProfileOccurrenceOrganizations();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalProfileOccurrenceOrganizations);
    });

    it('should have the property organization (base name: "organization")', function() {
      // uncomment below and update the code to test the property organization
      //var instance = new WebOfScienceJournalsApi.JournalProfileOccurrenceOrganizations();
