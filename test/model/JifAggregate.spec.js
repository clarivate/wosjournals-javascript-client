...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JifAggregate();
  });
  ...
  describe('JifAggregate', function() {
    it('should create an instance of JifAggregate', function() {
      // uncomment below and update the code to test JifAggregate
      //var instane = new WebOfScienceJournalsApi.JifAggregate();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JifAggregate);
    });

    it('should have the property count (base name: "count")', function() {
      // uncomment below and update the code to test the property count
      //var instance = new WebOfScienceJournalsApi.JifAggregate();
      //expect(instance).to.be();
    });

    it('should have the property citesYearAgo (base name: "citesYearAgo")', function() {
      // uncomment below and update the code to test the property citesYearAgo
      //var instance = new WebOfScienceJournalsApi.JifAggregate();
      //expect(instance).to.be();
    });

    it('should have the property citesTwoYearsAgo (base name: "citesTwoYearsAgo")', function() {
      // uncomment below and update the code to test the property citesTwoYearsAgo
      //var instance = new WebOfScienceJournalsApi.JifAggregate();
      //expect(instance).to.be();
    });

    it('should have the property publishedYearAgo (base name: "publishedYearAgo")', function() {
      // uncomment below and update the code to test the property publishedYearAgo
      //var instance = new WebOfScienceJournalsApi.JifAggregate();
      //expect(instance).to.be();
    });

    it('should have the property publishedTwoYearsAgo (base name: "publishedTwoYearsAgo")', function() {
      // uncomment below and update the code to test the property publishedTwoYearsAgo
      //var instance = new WebOfScienceJournalsApi.JifAggregate();
      //expect(instance).to.be();
    });
