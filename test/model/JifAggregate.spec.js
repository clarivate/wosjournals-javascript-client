...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JifAggregate();
  });
  ...
  describe('JifAggregate', function() {
    it('should create an instance of JifAggregate', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JifAggregate();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JifAggregate);
    });
