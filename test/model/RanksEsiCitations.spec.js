...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.RanksEsiCitations();
  });
  ...
  describe('RanksEsiCitations', function() {
    it('should create an instance of RanksEsiCitations', function() {
      // uncomment below and update the code to test RanksEsiCitations
      //var instane = new WebOfScienceJournalsApi.RanksEsiCitations();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.RanksEsiCitations);
    });

    it('should have the property category (base name: "category")', function() {
      // uncomment below and update the code to test the property category
      //var instance = new WebOfScienceJournalsApi.RanksEsiCitations();
