...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.RanksEsiCitations();
  });
  ...
  describe('RanksEsiCitations', function() {
    it('should create an instance of RanksEsiCitations', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.RanksEsiCitations();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.RanksEsiCitations);
    });
