...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoriesCitedJournal();
  });
  ...
  describe('CategoriesCitedJournal', function() {
    it('should create an instance of CategoriesCitedJournal', function() {
      // uncomment below and update the code to test CategoriesCitedJournal
      //var instane = new WebOfScienceJournalsApi.CategoriesCitedJournal();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoriesCitedJournal);
    });

    it('should have the property self (base name: "self")', function() {
      // uncomment below and update the code to test the property self
      //var instance = new WebOfScienceJournalsApi.CategoriesCitedJournal();
    ...
    it('should have the property citedJournals (base name: "citedJournals")', function() {
      // uncomment below and update the code to test the property citedJournals
      //var instance = new WebOfScienceJournalsApi.CategoriesCitedJournal();
      //expect(instance).to.be();
    });
