...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoriesCitedJournal();
  });
  ...
  describe('CategoriesCitedJournal', function() {
    it('should create an instance of CategoriesCitedJournal', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoriesCitedJournal();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoriesCitedJournal);
    });
