...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalReportsMetrics();
  });
  ...
  describe('JournalReportsMetrics', function() {
    it('should create an instance of JournalReportsMetrics', function() {
      // uncomment below and update the code to test JournalReportsMetrics
      //var instane = new WebOfScienceJournalsApi.JournalReportsMetrics();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalReportsMetrics);
    });

    it('should have the property impactMetrics (base name: "impactMetrics")', function() {
      // uncomment below and update the code to test the property impactMetrics
      //var instance = new WebOfScienceJournalsApi.JournalReportsMetrics();
      //expect(instance).to.be();
    });

    it('should have the property influenceMetrics (base name: "influenceMetrics")', function() {
      // uncomment below and update the code to test the property influenceMetrics
      //var instance = new WebOfScienceJournalsApi.JournalReportsMetrics();
      //expect(instance).to.be();
    });
