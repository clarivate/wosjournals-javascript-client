...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalReportsMetrics();
  });
  ...
  describe('JournalReportsMetrics', function() {
    it('should create an instance of JournalReportsMetrics', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalReportsMetrics();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalReportsMetrics);
    });
