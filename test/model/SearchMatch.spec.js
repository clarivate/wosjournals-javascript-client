...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.SearchMatch();
  });
  ...
  describe('SearchMatch', function() {
    it('should create an instance of SearchMatch', function() {
      // uncomment below and update the code to test SearchMatch
      //var instane = new WebOfScienceJournalsApi.SearchMatch();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.SearchMatch);
    });

    it('should have the property field (base name: "field")', function() {
      // uncomment below and update the code to test the property field
      //var instance = new WebOfScienceJournalsApi.SearchMatch();
