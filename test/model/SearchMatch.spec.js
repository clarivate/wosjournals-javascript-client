...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.SearchMatch();
  });
  ...
  describe('SearchMatch', function() {
    it('should create an instance of SearchMatch', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.SearchMatch();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.SearchMatch);
    });
