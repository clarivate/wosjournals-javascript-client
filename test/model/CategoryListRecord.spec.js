...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.CategoryListRecord();
  });
  ...
  describe('CategoryListRecord', function() {
    it('should create an instance of CategoryListRecord', function() {
      // uncomment below and update the code to test CategoryListRecord
      //var instane = new WebOfScienceJournalsApi.CategoryListRecord();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.CategoryListRecord);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new WebOfScienceJournalsApi.CategoryListRecord();
    ...
    it('should have the property categoryCitationReports (base name: "categoryCitationReports")', function() {
      // uncomment below and update the code to test the property categoryCitationReports
      //var instance = new WebOfScienceJournalsApi.CategoryListRecord();
      //expect(instance).to.be();
    });
