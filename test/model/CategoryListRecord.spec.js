...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.CategoryListRecord();
  });
  ...
  describe('CategoryListRecord', function() {
    it('should create an instance of CategoryListRecord', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.CategoryListRecord();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.CategoryListRecord);
    });
