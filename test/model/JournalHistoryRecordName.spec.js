...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordName();
  });
  ...
  describe('JournalHistoryRecordName', function() {
    it('should create an instance of JournalHistoryRecordName', function() {
      // uncomment below and update the code to test JournalHistoryRecordName
      //var instance = new ClarivateWosJournalsJsClient.JournalHistoryRecordName();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalHistoryRecordName);
    });
