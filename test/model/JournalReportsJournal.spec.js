...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebOfScienceJournalsApi.JournalReportsJournal();
  });
  ...
  describe('JournalReportsJournal', function() {
    it('should create an instance of JournalReportsJournal', function() {
      // uncomment below and update the code to test JournalReportsJournal
      //var instane = new WebOfScienceJournalsApi.JournalReportsJournal();
      //expect(instance).to.be.a(WebOfScienceJournalsApi.JournalReportsJournal);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new WebOfScienceJournalsApi.JournalReportsJournal();
