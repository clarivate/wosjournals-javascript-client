...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosJournalsJsClient.JournalReportsJournal();
  });
  ...
  describe('JournalReportsJournal', function() {
    it('should create an instance of JournalReportsJournal', function() {
      ...
      //var instance = new ClarivateWosJournalsJsClient.JournalReportsJournal();
      //expect(instance).to.be.a(ClarivateWosJournalsJsClient.JournalReportsJournal);
    });
