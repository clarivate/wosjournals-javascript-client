...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default http://api.clarivate.com/apis/wos-journals/v1
         */
        this.basePath = 'http://api.clarivate.com/apis/wos-journals/v1'.replace(/\/+$/, '');
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "http://api.clarivate.com/apis/wos-journals/v1",
