...
/**
 * The SearchMatch model module.
 * @module model/SearchMatch
 * @version 1.0.0
 */
class SearchMatch {
    /**
     * Constructs a new <code>SearchMatch</code>.
     * Displays the field and value matched to the search string
     * @alias module:model/SearchMatch
     */
    constructor() { 
        
        SearchMatch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchMatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchMatch} obj Optional instance to populate.
     * @return {module:model/SearchMatch} The populated <code>SearchMatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchMatch();
 ...
 * @member {String} field
 */
SearchMatch.prototype['field'] = undefined;

/**
 * Array of matched values (if several) with the HTML highligthing
 * @member {Array.<String>} value
 */
SearchMatch.prototype['value'] = undefined;
