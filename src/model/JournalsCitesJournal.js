...
/**
 * The JournalsCitesJournal model module.
 * @module model/JournalsCitesJournal
 * @version 1.0.0
 */
class JournalsCitesJournal {
    /**
     * Constructs a new <code>JournalsCitesJournal</code>.
     * @alias module:model/JournalsCitesJournal
     */
    constructor() { 
        
        JournalsCitesJournal.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalsCitesJournal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalsCitesJournal} obj Optional instance to populate.
     * @return {module:model/JournalsCitesJournal} The populated <code>JournalsCitesJournal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalsCitesJournal();
 ...
 * @member {String} self
 */
JournalsCitesJournal.prototype['self'] = undefined;

/**
 * @member {String} name
 */
JournalsCitesJournal.prototype['name'] = undefined;
...
export default JournalsCitesJournal;
