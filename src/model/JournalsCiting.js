...
import JournalsCitingHits from './JournalsCitingHits';
import Metadata from './Metadata';

/**
 * The JournalsCiting model module.
 * @module model/JournalsCiting
 * @version 1.0.0
 */
class JournalsCiting {
    /**
     * Constructs a new <code>JournalsCiting</code>.
     * @alias module:model/JournalsCiting
     */
    constructor() { 
        
        JournalsCiting.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalsCiting</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalsCiting} obj Optional instance to populate.
     * @return {module:model/JournalsCiting} The populated <code>JournalsCiting</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalsCiting();

            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = Metadata.constructFromObject(data['metadata']);
            }
            if (data.hasOwnProperty('hits')) {
                obj['hits'] = ApiClient.convertToType(data['hits'], [JournalsCitingHits]);
            }
        }
        return obj;
    }
 ...
 */
JournalsCiting.prototype['metadata'] = undefined;

/**
 * @member {Array.<module:model/JournalsCitingHits>} hits
 */
JournalsCiting.prototype['hits'] = undefined;
