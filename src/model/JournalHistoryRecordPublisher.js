...
/**
 * The JournalHistoryRecordPublisher model module.
 * @module model/JournalHistoryRecordPublisher
 * @version 1.0.0
 */
class JournalHistoryRecordPublisher {
    /**
     * Constructs a new <code>JournalHistoryRecordPublisher</code>.
     * @alias module:model/JournalHistoryRecordPublisher
     */
    constructor() { 
        
        JournalHistoryRecordPublisher.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalHistoryRecordPublisher</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalHistoryRecordPublisher} obj Optional instance to populate.
     * @return {module:model/JournalHistoryRecordPublisher} The populated <code>JournalHistoryRecordPublisher</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalHistoryRecordPublisher();
 ...
 * @member {String} name
 */
JournalHistoryRecordPublisher.prototype['name'] = undefined;

/**
 * Publisher address
 * @member {String} address
 */
JournalHistoryRecordPublisher.prototype['address'] = undefined;

/**
 * Publisher country/region
 * @member {String} countryRegion
 */
JournalHistoryRecordPublisher.prototype['countryRegion'] = undefined;
...
export default JournalHistoryRecordPublisher;
