...
import CategoriesCitedHits from './CategoriesCitedHits';
import Metadata from './Metadata';

/**
 * The CategoriesCited model module.
 * @module model/CategoriesCited
 * @version 1.0.0
 */
class CategoriesCited {
    /**
     * Constructs a new <code>CategoriesCited</code>.
     * @alias module:model/CategoriesCited
     */
    constructor() { 
        
        CategoriesCited.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoriesCited</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoriesCited} obj Optional instance to populate.
     * @return {module:model/CategoriesCited} The populated <code>CategoriesCited</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoriesCited();

            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = Metadata.constructFromObject(data['metadata']);
            }
            if (data.hasOwnProperty('hits')) {
                obj['hits'] = ApiClient.convertToType(data['hits'], [CategoriesCitedHits]);
            }
        }
        return obj;
    }
 ...
 */
CategoriesCited.prototype['metadata'] = undefined;

/**
 * @member {Array.<module:model/CategoriesCitedHits>} hits
 */
CategoriesCited.prototype['hits'] = undefined;
...
export default CategoriesCited;
