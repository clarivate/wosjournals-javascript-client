...
/**
 * The CategoryListRecord model module.
 * @module model/CategoryListRecord
 * @version 1.0.0
 */
class CategoryListRecord {
    /**
     * Constructs a new <code>CategoryListRecord</code>.
     * @alias module:model/CategoryListRecord
     */
    constructor() { 
        
        CategoryListRecord.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoryListRecord</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoryListRecord} obj Optional instance to populate.
     * @return {module:model/CategoryListRecord} The populated <code>CategoryListRecord</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryListRecord();
            ...
            if (data.hasOwnProperty('categoryCitationReports')) {
                obj['categoryCitationReports'] = ApiClient.convertToType(data['categoryCitationReports'], [Object]);
            }
        }
        return obj;
    }
 ...
 * @member {String} id
 */
CategoryListRecord.prototype['id'] = undefined;

/**
 * Link to the category entity
 * @member {String} self
 */
CategoryListRecord.prototype['self'] = undefined;

/**
 * Search string matches across category names
 * @member {Array.<module:model/SearchMatch>} matches
 */
CategoryListRecord.prototype['matches'] = undefined;

/**
 * Category name
 * @member {String} name
 */
CategoryListRecord.prototype['name'] = undefined;

/**
 * Category edition (SCIE/SSCI)
 * @member {String} edition
 */
CategoryListRecord.prototype['edition'] = undefined;

/**
 * @member {Array.<Object>} categoryCitationReports
 */
CategoryListRecord.prototype['categoryCitationReports'] = undefined;
...
export default CategoryListRecord;
