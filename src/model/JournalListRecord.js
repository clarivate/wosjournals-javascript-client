...
import JournalListRecordJournalCitationReports from './JournalListRecordJournalCitationReports';
import JournalListRecordMetrics from './JournalListRecordMetrics';
import JournalListRecordRanks from './JournalListRecordRanks';
import SearchMatch from './SearchMatch';

/**
 * The JournalListRecord model module.
 * @module model/JournalListRecord
 * @version 1.0.0
 */
class JournalListRecord {
    /**
     * Constructs a new <code>JournalListRecord</code>.
     * @alias module:model/JournalListRecord
     */
    constructor() { 
        
        JournalListRecord.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalListRecord</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalListRecord} obj Optional instance to populate.
     * @return {module:model/JournalListRecord} The populated <code>JournalListRecord</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalListRecord();
            ...
            if (data.hasOwnProperty('matches')) {
                obj['matches'] = ApiClient.convertToType(data['matches'], [SearchMatch]);
            }
            ...
            if (data.hasOwnProperty('journalCitationReports')) {
                obj['journalCitationReports'] = ApiClient.convertToType(data['journalCitationReports'], [JournalListRecordJournalCitationReports]);
            }
            if (data.hasOwnProperty('metrics')) {
                obj['metrics'] = JournalListRecordMetrics.constructFromObject(data['metrics']);
            }
            if (data.hasOwnProperty('ranks')) {
                obj['ranks'] = JournalListRecordRanks.constructFromObject(data['ranks']);
            }
        }
        return obj;
    }
 ...
 * @member {String} id
 */
JournalListRecord.prototype['id'] = undefined;

/**
 * Link to the journal entity
 * @member {String} self
 */
JournalListRecord.prototype['self'] = undefined;

/**
 * @member {Array.<module:model/SearchMatch>} matches
 */
JournalListRecord.prototype['matches'] = undefined;

/**
 * Journal full name
 * @member {String} name
 */
JournalListRecord.prototype['name'] = undefined;

/**
 * List of journal categories with related editions/databases
 * @member {Array.<Object>} categories
 */
JournalListRecord.prototype['categories'] = undefined;

/**
 * Journal citation report link (only if the filter \"jcrYear\" was selected)
 * @member {Array.<module:model/JournalListRecordJournalCitationReports>} journalCitationReports
 */
JournalListRecord.prototype['journalCitationReports'] = undefined;

/**
 * @member {module:model/JournalListRecordMetrics} metrics
 */
JournalListRecord.prototype['metrics'] = undefined;

/**
 * @member {module:model/JournalListRecordRanks} ranks
 */
JournalListRecord.prototype['ranks'] = undefined;
...
export default JournalListRecord;
