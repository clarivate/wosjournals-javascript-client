...
/**
 * The JifAggregate model module.
 * @module model/JifAggregate
 * @version 1.0.0
 */
class JifAggregate {
    /**
     * Constructs a new <code>JifAggregate</code>.
     * @alias module:model/JifAggregate
     */
    constructor() { 
        
        JifAggregate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JifAggregate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JifAggregate} obj Optional instance to populate.
     * @return {module:model/JifAggregate} The populated <code>JifAggregate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JifAggregate();

            if (data.hasOwnProperty('count')) {
                obj['count'] = ApiClient.convertToType(data['count'], 'String');
            }
            if (data.hasOwnProperty('citesYearAgo')) {
                obj['citesYearAgo'] = ApiClient.convertToType(data['citesYearAgo'], 'Number');
            }
            if (data.hasOwnProperty('citesTwoYearsAgo')) {
                obj['citesTwoYearsAgo'] = ApiClient.convertToType(data['citesTwoYearsAgo'], 'Number');
            }
            if (data.hasOwnProperty('publishedYearAgo')) {
                obj['publishedYearAgo'] = ApiClient.convertToType(data['publishedYearAgo'], 'Number');
            }
            if (data.hasOwnProperty('publishedTwoYearsAgo')) {
                obj['publishedTwoYearsAgo'] = ApiClient.convertToType(data['publishedTwoYearsAgo'], 'Number');
            }
        }
        return obj;
    }
 ...
 * @member {String} count
 */
JifAggregate.prototype['count'] = undefined;

/**
 * @member {Number} citesYearAgo
 */
JifAggregate.prototype['citesYearAgo'] = undefined;

/**
 * @member {Number} citesTwoYearsAgo
 */
JifAggregate.prototype['citesTwoYearsAgo'] = undefined;

/**
 * @member {Number} publishedYearAgo
 */
JifAggregate.prototype['publishedYearAgo'] = undefined;

/**
 * @member {Number} publishedTwoYearsAgo
 */
JifAggregate.prototype['publishedTwoYearsAgo'] = undefined;
