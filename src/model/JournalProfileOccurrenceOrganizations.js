...
/**
 * The JournalProfileOccurrenceOrganizations model module.
 * @module model/JournalProfileOccurrenceOrganizations
 * @version 1.0.0
 */
class JournalProfileOccurrenceOrganizations {
    /**
     * Constructs a new <code>JournalProfileOccurrenceOrganizations</code>.
     * @alias module:model/JournalProfileOccurrenceOrganizations
     */
    constructor() { 
        
        JournalProfileOccurrenceOrganizations.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalProfileOccurrenceOrganizations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalProfileOccurrenceOrganizations} obj Optional instance to populate.
     * @return {module:model/JournalProfileOccurrenceOrganizations} The populated <code>JournalProfileOccurrenceOrganizations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalProfileOccurrenceOrganizations();
 ...
 */
JournalProfileOccurrenceOrganizations.prototype['organization'] = undefined;

/**
 * Number of organization's articles/reviews/etc
 * @member {Number} occurrence
 */
JournalProfileOccurrenceOrganizations.prototype['occurrence'] = undefined;
...
export default JournalProfileOccurrenceOrganizations;
