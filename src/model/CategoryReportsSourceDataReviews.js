...
/**
 * The CategoryReportsSourceDataReviews model module.
 * @module model/CategoryReportsSourceDataReviews
 * @version 1.0.0
 */
class CategoryReportsSourceDataReviews {
    /**
     * Constructs a new <code>CategoryReportsSourceDataReviews</code>.
     * @alias module:model/CategoryReportsSourceDataReviews
     */
    constructor() { 
        
        CategoryReportsSourceDataReviews.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoryReportsSourceDataReviews</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoryReportsSourceDataReviews} obj Optional instance to populate.
     * @return {module:model/CategoryReportsSourceDataReviews} The populated <code>CategoryReportsSourceDataReviews</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryReportsSourceDataReviews();
 ...
 * @member {Number} count
 */
CategoryReportsSourceDataReviews.prototype['count'] = undefined;

/**
 * Total count of review references
 * @member {Number} references
 */
CategoryReportsSourceDataReviews.prototype['references'] = undefined;
...
export default CategoryReportsSourceDataReviews;
