...
/**
 * The JournalReportsMetrics model module.
 * @module model/JournalReportsMetrics
 * @version 1.0.0
 */
class JournalReportsMetrics {
    /**
     * Constructs a new <code>JournalReportsMetrics</code>.
     ...
     * @alias module:model/JournalReportsMetrics
     */
    constructor() { 
        
        JournalReportsMetrics.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalReportsMetrics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalReportsMetrics} obj Optional instance to populate.
     * @return {module:model/JournalReportsMetrics} The populated <code>JournalReportsMetrics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalReportsMetrics();

            if (data.hasOwnProperty('impactMetrics')) {
                obj['impactMetrics'] = ImpactMetrics.constructFromObject(data['impactMetrics']);
            }
            if (data.hasOwnProperty('influenceMetrics')) {
                obj['influenceMetrics'] = InfluenceMetrics.constructFromObject(data['influenceMetrics']);
            }
            if (data.hasOwnProperty('sourceMetrics')) {
                obj['sourceMetrics'] = SourceMetrics.constructFromObject(data['sourceMetrics']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/ImpactMetrics} impactMetrics
 */
JournalReportsMetrics.prototype['impactMetrics'] = undefined;

/**
 * @member {module:model/InfluenceMetrics} influenceMetrics
 */
JournalReportsMetrics.prototype['influenceMetrics'] = undefined;

/**
 * @member {module:model/SourceMetrics} sourceMetrics
 */
JournalReportsMetrics.prototype['sourceMetrics'] = undefined;
...
export default JournalReportsMetrics;
