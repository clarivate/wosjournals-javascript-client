...
/**
 * The JournalProfileCitableItems model module.
 * @module model/JournalProfileCitableItems
 * @version 1.0.0
 */
class JournalProfileCitableItems {
    /**
     * Constructs a new <code>JournalProfileCitableItems</code>.
     ...
     * @alias module:model/JournalProfileCitableItems
     */
    constructor() { 
        
        JournalProfileCitableItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalProfileCitableItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalProfileCitableItems} obj Optional instance to populate.
     * @return {module:model/JournalProfileCitableItems} The populated <code>JournalProfileCitableItems</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalProfileCitableItems();
 ...
 */
JournalProfileCitableItems.prototype['goldOA'] = undefined;

/**
 * @member {Number} subscription
 */
JournalProfileCitableItems.prototype['subscription'] = undefined;

/**
 * @member {Number} other
 */
JournalProfileCitableItems.prototype['other'] = undefined;
...
export default JournalProfileCitableItems;
