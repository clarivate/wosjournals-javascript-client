...
import JournalListRecordRanksJif from './JournalListRecordRanksJif';

/**
 * The JournalListRecordRanks model module.
 * @module model/JournalListRecordRanks
 * @version 1.0.0
 */
class JournalListRecordRanks {
    /**
     * Constructs a new <code>JournalListRecordRanks</code>.
     * Journal ranks information (only if the filter \&quot;jifQuartle\&quot; was selected)
     * @alias module:model/JournalListRecordRanks
     */
    constructor() { 
        
        JournalListRecordRanks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalListRecordRanks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalListRecordRanks} obj Optional instance to populate.
     * @return {module:model/JournalListRecordRanks} The populated <code>JournalListRecordRanks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalListRecordRanks();

            if (data.hasOwnProperty('jif')) {
                obj['jif'] = ApiClient.convertToType(data['jif'], [JournalListRecordRanksJif]);
            }
...
/**
 * @member {Array.<module:model/JournalListRecordRanksJif>} jif
 */
JournalListRecordRanks.prototype['jif'] = undefined;

/**
 * @member {Array.<module:model/JournalListRecordRanksJci>} jci
 */
JournalListRecordRanks.prototype['jci'] = undefined;
...
export default JournalListRecordRanks;
