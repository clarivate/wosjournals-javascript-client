...
import CategoriesCitingJournal from './CategoriesCitingJournal';

/**
 * The CategoriesCitingHits model module.
 * @module model/CategoriesCitingHits
 * @version 1.0.0
 */
class CategoriesCitingHits {
    /**
     * Constructs a new <code>CategoriesCitingHits</code>.
     * @alias module:model/CategoriesCitingHits
     */
    constructor() { 
        
        CategoriesCitingHits.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoriesCitingHits</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoriesCitingHits} obj Optional instance to populate.
     * @return {module:model/CategoriesCitingHits} The populated <code>CategoriesCitingHits</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoriesCitingHits();

            if (data.hasOwnProperty('journal')) {
                obj['journal'] = CategoriesCitingJournal.constructFromObject(data['journal']);
            }
            if (data.hasOwnProperty('cited')) {
                obj['cited'] = ApiClient.convertToType(data['cited'], [Object]);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/CategoriesCitingJournal} journal
 */
CategoriesCitingHits.prototype['journal'] = undefined;

/**
 * @member {Array.<Object>} cited
 */
CategoriesCitingHits.prototype['cited'] = undefined;
...
export default CategoriesCitingHits;
