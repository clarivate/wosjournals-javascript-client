...
/**
 * The JournalListRecordRanksJif model module.
 * @module model/JournalListRecordRanksJif
 * @version 1.0.0
 */
class JournalListRecordRanksJif {
    /**
     * Constructs a new <code>JournalListRecordRanksJif</code>.
     * @alias module:model/JournalListRecordRanksJif
     */
    constructor() { 
        
        JournalListRecordRanksJif.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalListRecordRanksJif</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalListRecordRanksJif} obj Optional instance to populate.
     * @return {module:model/JournalListRecordRanksJif} The populated <code>JournalListRecordRanksJif</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalListRecordRanksJif();
 ...
 */
JournalListRecordRanksJif.prototype['category'] = undefined;

/**
 * @member {String} edition
 */
JournalListRecordRanksJif.prototype['edition'] = undefined;

/**
 * @member {String} self
 */
JournalListRecordRanksJif.prototype['self'] = undefined;

/**
 * @member {String} rank
 */
JournalListRecordRanksJif.prototype['rank'] = undefined;

/**
 * @member {String} quartile
 */
JournalListRecordRanksJif.prototype['quartile'] = undefined;
...
export default JournalListRecordRanksJif;
