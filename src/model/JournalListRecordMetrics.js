...
import JournalListRecordMetricsImpactMetrics from './JournalListRecordMetricsImpactMetrics';
import JournalListRecordMetricsSourceMetrics from './JournalListRecordMetricsSourceMetrics';

/**
 * The JournalListRecordMetrics model module.
 * @module model/JournalListRecordMetrics
 * @version 1.0.0
 */
class JournalListRecordMetrics {
    /**
     * Constructs a new <code>JournalListRecordMetrics</code>.
     * Journal metrics information (only if the filter(s) \&quot;jif\&quot; or \&quot;jifPercentile\&quot; were selected)
     * @alias module:model/JournalListRecordMetrics
     */
    constructor() { 
        
        JournalListRecordMetrics.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalListRecordMetrics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalListRecordMetrics} obj Optional instance to populate.
     * @return {module:model/JournalListRecordMetrics} The populated <code>JournalListRecordMetrics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalListRecordMetrics();

            if (data.hasOwnProperty('impactMetrics')) {
                obj['impactMetrics'] = JournalListRecordMetricsImpactMetrics.constructFromObject(data['impactMetrics']);
            }
            if (data.hasOwnProperty('sourceMetrics')) {
                obj['sourceMetrics'] = JournalListRecordMetricsSourceMetrics.constructFromObject(data['sourceMetrics']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/JournalListRecordMetricsImpactMetrics} impactMetrics
 */
JournalListRecordMetrics.prototype['impactMetrics'] = undefined;

/**
 * @member {module:model/JournalListRecordMetricsSourceMetrics} sourceMetrics
 */
JournalListRecordMetrics.prototype['sourceMetrics'] = undefined;
...
export default JournalListRecordMetrics;
