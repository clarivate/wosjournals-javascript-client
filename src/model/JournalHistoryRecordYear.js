...
/**
 * The JournalHistoryRecordYear model module.
 * @module model/JournalHistoryRecordYear
 * @version 1.0.0
 */
class JournalHistoryRecordYear {
    /**
     * Constructs a new <code>JournalHistoryRecordYear</code>.
     * @alias module:model/JournalHistoryRecordYear
     */
    constructor() { 
        
        JournalHistoryRecordYear.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalHistoryRecordYear</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalHistoryRecordYear} obj Optional instance to populate.
     * @return {module:model/JournalHistoryRecordYear} The populated <code>JournalHistoryRecordYear</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalHistoryRecordYear();
 ...
 * @member {Number} start
 */
JournalHistoryRecordYear.prototype['start'] = undefined;

/**
 * Last year of name
 * @member {Number} end
 */
JournalHistoryRecordYear.prototype['end'] = undefined;
...
export default JournalHistoryRecordYear;
