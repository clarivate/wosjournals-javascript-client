...
/**
 * The JournalReportsJournal model module.
 * @module model/JournalReportsJournal
 * @version 1.0.0
 */
class JournalReportsJournal {
    /**
     * Constructs a new <code>JournalReportsJournal</code>.
     * Main information about the report journal
     * @alias module:model/JournalReportsJournal
     */
    constructor() { 
        
        JournalReportsJournal.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalReportsJournal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalReportsJournal} obj Optional instance to populate.
     * @return {module:model/JournalReportsJournal} The populated <code>JournalReportsJournal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalReportsJournal();
 ...
 * @member {String} id
 */
JournalReportsJournal.prototype['id'] = undefined;

/**
 * Journals API link to the journal entity
 * @member {String} self
 */
JournalReportsJournal.prototype['self'] = undefined;

/**
 * Journal title
 * @member {String} name
 */
JournalReportsJournal.prototype['name'] = undefined;
...
export default JournalReportsJournal;
