...
/**
 * The JournalProfileOccurrenceCountries model module.
 * @module model/JournalProfileOccurrenceCountries
 * @version 1.0.0
 */
class JournalProfileOccurrenceCountries {
    /**
     * Constructs a new <code>JournalProfileOccurrenceCountries</code>.
     * @alias module:model/JournalProfileOccurrenceCountries
     */
    constructor() { 
        
        JournalProfileOccurrenceCountries.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalProfileOccurrenceCountries</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalProfileOccurrenceCountries} obj Optional instance to populate.
     * @return {module:model/JournalProfileOccurrenceCountries} The populated <code>JournalProfileOccurrenceCountries</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalProfileOccurrenceCountries();

            if (data.hasOwnProperty('countryRegion')) {
                obj['countryRegion'] = ApiClient.convertToType(data['countryRegion'], 'String');
            }
 ...
 */
JournalProfileOccurrenceCountries.prototype['countryRegion'] = undefined;

/**
 * Number of country/region's articles/reviews/etc
 * @member {Number} occurrence
 */
JournalProfileOccurrenceCountries.prototype['occurrence'] = undefined;
...
export default JournalProfileOccurrenceCountries;
