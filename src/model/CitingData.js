...
/**
 * The CitingData model module.
 * @module model/CitingData
 * @version 1.0.0
 */
class CitingData {
    /**
     * Constructs a new <code>CitingData</code>.
     * @alias module:model/CitingData
     */
    constructor() { 
        
        CitingData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CitingData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CitingData} obj Optional instance to populate.
     * @return {module:model/CitingData} The populated <code>CitingData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CitingData();
 ...
 * @member {String} url
 */
CitingData.prototype['url'] = undefined;

/**
 * Number of citing journals
 * @member {Number} count
 */
CitingData.prototype['count'] = undefined;
