...
/**
 * The CategoryReportsJournals model module.
 * @module model/CategoryReportsJournals
 * @version 1.0.0
 */
class CategoryReportsJournals {
    /**
     * Constructs a new <code>CategoryReportsJournals</code>.
     * @alias module:model/CategoryReportsJournals
     */
    constructor() { 
        
        CategoryReportsJournals.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoryReportsJournals</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoryReportsJournals} obj Optional instance to populate.
     * @return {module:model/CategoryReportsJournals} The populated <code>CategoryReportsJournals</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryReportsJournals();
 ...
 * @member {Number} count
 */
CategoryReportsJournals.prototype['count'] = undefined;

/**
 * @member {String} url
 */
CategoryReportsJournals.prototype['url'] = undefined;
...
export default CategoryReportsJournals;
