...
import JournalHistoryRecordPublisher from './JournalHistoryRecordPublisher';
import JournalHistoryRecordYear2 from './JournalHistoryRecordYear2';

/**
 * The JournalHistoryRecordPublisher1 model module.
 * @module model/JournalHistoryRecordPublisher1
 * @version 1.0.0
 */
class JournalHistoryRecordPublisher1 {
    /**
     * Constructs a new <code>JournalHistoryRecordPublisher1</code>.
     * @alias module:model/JournalHistoryRecordPublisher1
     */
    constructor() { 
        
        JournalHistoryRecordPublisher1.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalHistoryRecordPublisher1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalHistoryRecordPublisher1} obj Optional instance to populate.
     * @return {module:model/JournalHistoryRecordPublisher1} The populated <code>JournalHistoryRecordPublisher1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalHistoryRecordPublisher1();

            if (data.hasOwnProperty('publisher')) {
                obj['publisher'] = JournalHistoryRecordPublisher.constructFromObject(data['publisher']);
            }
            if (data.hasOwnProperty('year')) {
                obj['year'] = JournalHistoryRecordYear2.constructFromObject(data['year']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/JournalHistoryRecordPublisher} publisher
 */
JournalHistoryRecordPublisher1.prototype['publisher'] = undefined;

/**
 * @member {module:model/JournalHistoryRecordYear2} year
 */
JournalHistoryRecordPublisher1.prototype['year'] = undefined;
...
export default JournalHistoryRecordPublisher1;
