...
import JournalHistoryRecordYear from './JournalHistoryRecordYear';

/**
 * The JournalHistoryRecordName model module.
 * @module model/JournalHistoryRecordName
 * @version 1.0.0
 */
class JournalHistoryRecordName {
    /**
     * Constructs a new <code>JournalHistoryRecordName</code>.
     * @alias module:model/JournalHistoryRecordName
     */
    constructor() { 
        
        JournalHistoryRecordName.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalHistoryRecordName</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalHistoryRecordName} obj Optional instance to populate.
     * @return {module:model/JournalHistoryRecordName} The populated <code>JournalHistoryRecordName</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalHistoryRecordName();

            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('year')) {
                obj['year'] = JournalHistoryRecordYear.constructFromObject(data['year']);
            }
        }
        return obj;
    }
 ...
 * @member {String} name
 */
JournalHistoryRecordName.prototype['name'] = undefined;

/**
 * @member {module:model/JournalHistoryRecordYear} year
 */
JournalHistoryRecordName.prototype['year'] = undefined;
...
export default JournalHistoryRecordName;
