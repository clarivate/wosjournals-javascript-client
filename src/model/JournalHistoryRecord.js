...
import JournalHistoryRecordIsoTitle from './JournalHistoryRecordIsoTitle';
import JournalHistoryRecordIssn from './JournalHistoryRecordIssn';
import JournalHistoryRecordName from './JournalHistoryRecordName';
import JournalHistoryRecordPublisher1 from './JournalHistoryRecordPublisher1';

/**
 * The JournalHistoryRecord model module.
 * @module model/JournalHistoryRecord
 * @version 1.0.0
 */
class JournalHistoryRecord {
    /**
     * Constructs a new <code>JournalHistoryRecord</code>.
     * TBD
     * @alias module:model/JournalHistoryRecord
     */
    constructor() { 
        
        JournalHistoryRecord.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalHistoryRecord</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalHistoryRecord} obj Optional instance to populate.
     * @return {module:model/JournalHistoryRecord} The populated <code>JournalHistoryRecord</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalHistoryRecord();

            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], [JournalHistoryRecordName]);
            }
            if (data.hasOwnProperty('issn')) {
                obj['issn'] = ApiClient.convertToType(data['issn'], [JournalHistoryRecordIssn]);
            }
            if (data.hasOwnProperty('publisher')) {
                obj['publisher'] = ApiClient.convertToType(data['publisher'], [JournalHistoryRecordPublisher1]);
            }
            if (data.hasOwnProperty('isoTitle')) {
                obj['isoTitle'] = ApiClient.convertToType(data['isoTitle'], [JournalHistoryRecordIsoTitle]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/JournalHistoryRecordName>} name
 */
JournalHistoryRecord.prototype['name'] = undefined;

/**
 * Previously assigned ISSN identifiers
 * @member {Array.<module:model/JournalHistoryRecordIssn>} issn
 */
JournalHistoryRecord.prototype['issn'] = undefined;

/**
 * Previously assigned publishers
 * @member {Array.<module:model/JournalHistoryRecordPublisher1>} publisher
 */
JournalHistoryRecord.prototype['publisher'] = undefined;

/**
 * Previously assigned ISO titles
 * @member {Array.<module:model/JournalHistoryRecordIsoTitle>} isoTitle
 */
JournalHistoryRecord.prototype['isoTitle'] = undefined;
...
export default JournalHistoryRecord;
