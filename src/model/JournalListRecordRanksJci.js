...
/**
 * The JournalListRecordRanksJci model module.
 * @module model/JournalListRecordRanksJci
 * @version 1.0.0
 */
class JournalListRecordRanksJci {
    /**
     * Constructs a new <code>JournalListRecordRanksJci</code>.
     * @alias module:model/JournalListRecordRanksJci
     */
    constructor() { 
        
        JournalListRecordRanksJci.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalListRecordRanksJci</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalListRecordRanksJci} obj Optional instance to populate.
     * @return {module:model/JournalListRecordRanksJci} The populated <code>JournalListRecordRanksJci</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalListRecordRanksJci();
            ...
            if (data.hasOwnProperty('jciPercentile')) {
                obj['jciPercentile'] = ApiClient.convertToType(data['jciPercentile'], 'Number');
            }
        }
        return obj;
    }
 ...
 */
JournalListRecordRanksJci.prototype['category'] = undefined;

/**
 * @member {String} rank
 */
JournalListRecordRanksJci.prototype['rank'] = undefined;

/**
 * @member {String} quartile
 */
JournalListRecordRanksJci.prototype['quartile'] = undefined;

/**
 * @member {Number} jciPercentile
 */
JournalListRecordRanksJci.prototype['jciPercentile'] = undefined;
...
export default JournalListRecordRanksJci;
