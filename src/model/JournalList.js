...
import JournalListRecord from './JournalListRecord';
import Metadata from './Metadata';

/**
 * The JournalList model module.
 * @module model/JournalList
 * @version 1.0.0
 */
class JournalList {
    /**
     * Constructs a new <code>JournalList</code>.
     * @alias module:model/JournalList
     */
    constructor() { 
        
        JournalList.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalList} obj Optional instance to populate.
     * @return {module:model/JournalList} The populated <code>JournalList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalList();

            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = Metadata.constructFromObject(data['metadata']);
            }
            if (data.hasOwnProperty('hits')) {
                obj['hits'] = ApiClient.convertToType(data['hits'], [JournalListRecord]);
            }
        }
        return obj;
    }
 ...
 */
JournalList.prototype['metadata'] = undefined;

/**
 * @member {Array.<module:model/JournalListRecord>} hits
 */
JournalList.prototype['hits'] = undefined;
