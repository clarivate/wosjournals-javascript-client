...
import JournalsCitedHits from './JournalsCitedHits';
import Metadata from './Metadata';

/**
 * The JournalsCited model module.
 * @module model/JournalsCited
 * @version 1.0.0
 */
class JournalsCited {
    /**
     * Constructs a new <code>JournalsCited</code>.
     * @alias module:model/JournalsCited
     */
    constructor() { 
        
        JournalsCited.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalsCited</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalsCited} obj Optional instance to populate.
     * @return {module:model/JournalsCited} The populated <code>JournalsCited</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalsCited();

            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = Metadata.constructFromObject(data['metadata']);
            }
            if (data.hasOwnProperty('hits')) {
                obj['hits'] = ApiClient.convertToType(data['hits'], [JournalsCitedHits]);
            }
        }
        return obj;
    }
 ...
 */
JournalsCited.prototype['metadata'] = undefined;

/**
 * @member {Array.<module:model/JournalsCitedHits>} hits
 */
JournalsCited.prototype['hits'] = undefined;
