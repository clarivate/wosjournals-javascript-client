...
import JournalHistoryRecordYear3 from './JournalHistoryRecordYear3';

/**
 * The JournalHistoryRecordIsoTitle model module.
 * @module model/JournalHistoryRecordIsoTitle
 * @version 1.0.0
 */
class JournalHistoryRecordIsoTitle {
    /**
     * Constructs a new <code>JournalHistoryRecordIsoTitle</code>.
     * @alias module:model/JournalHistoryRecordIsoTitle
     */
    constructor() { 
        
        JournalHistoryRecordIsoTitle.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalHistoryRecordIsoTitle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalHistoryRecordIsoTitle} obj Optional instance to populate.
     * @return {module:model/JournalHistoryRecordIsoTitle} The populated <code>JournalHistoryRecordIsoTitle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalHistoryRecordIsoTitle();

            if (data.hasOwnProperty('isoTitle')) {
                obj['isoTitle'] = ApiClient.convertToType(data['isoTitle'], 'String');
            }
            if (data.hasOwnProperty('year')) {
                obj['year'] = JournalHistoryRecordYear3.constructFromObject(data['year']);
            }
        }
        return obj;
    }
 ...
 */
JournalHistoryRecordIsoTitle.prototype['isoTitle'] = undefined;

/**
 * @member {module:model/JournalHistoryRecordYear3} year
 */
JournalHistoryRecordIsoTitle.prototype['year'] = undefined;
...
export default JournalHistoryRecordIsoTitle;
