...
/**
 * The SourceMetricsCitableItems model module.
 * @module model/SourceMetricsCitableItems
 * @version 1.0.0
 */
class SourceMetricsCitableItems {
    /**
     * Constructs a new <code>SourceMetricsCitableItems</code>.
     * @alias module:model/SourceMetricsCitableItems
     */
    constructor() { 
        
        SourceMetricsCitableItems.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SourceMetricsCitableItems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SourceMetricsCitableItems} obj Optional instance to populate.
     * @return {module:model/SourceMetricsCitableItems} The populated <code>SourceMetricsCitableItems</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SourceMetricsCitableItems();

            if (data.hasOwnProperty('total')) {
                obj['total'] = ApiClient.convertToType(data['total'], 'Number');
            }
            if (data.hasOwnProperty('articlesPercentage')) {
                obj['articlesPercentage'] = ApiClient.convertToType(data['articlesPercentage'], 'Number');
            }
        }
        return obj;
    }
 ...
 * @member {Number} total
 */
SourceMetricsCitableItems.prototype['total'] = undefined;

/**
 * @member {Number} articlesPercentage
 */
SourceMetricsCitableItems.prototype['articlesPercentage'] = undefined;
...
export default SourceMetricsCitableItems;
