...
/**
 * The CategoryReportsSourceDataArticles model module.
 * @module model/CategoryReportsSourceDataArticles
 * @version 1.0.0
 */
class CategoryReportsSourceDataArticles {
    /**
     * Constructs a new <code>CategoryReportsSourceDataArticles</code>.
     * @alias module:model/CategoryReportsSourceDataArticles
     */
    constructor() { 
        
        CategoryReportsSourceDataArticles.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoryReportsSourceDataArticles</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoryReportsSourceDataArticles} obj Optional instance to populate.
     * @return {module:model/CategoryReportsSourceDataArticles} The populated <code>CategoryReportsSourceDataArticles</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryReportsSourceDataArticles();
 ...
 * @member {Number} count
 */
CategoryReportsSourceDataArticles.prototype['count'] = undefined;

/**
 * Total count of article references
 * @member {Number} references
 */
CategoryReportsSourceDataArticles.prototype['references'] = undefined;
...
export default CategoryReportsSourceDataArticles;
