...
import JournalProfileCitableItems from './JournalProfileCitableItems';
import JournalProfileCitations from './JournalProfileCitations';
import JournalProfileOccurrenceCountries from './JournalProfileOccurrenceCountries';
import JournalProfileOccurrenceOrganizations from './JournalProfileOccurrenceOrganizations';

/**
 * The JournalProfile model module.
 * @module model/JournalProfile
 * @version 1.0.0
 */
class JournalProfile {
    /**
     * Constructs a new <code>JournalProfile</code>.
     ...
     * @alias module:model/JournalProfile
     */
    constructor() { 
        
        JournalProfile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalProfile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalProfile} obj Optional instance to populate.
     * @return {module:model/JournalProfile} The populated <code>JournalProfile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalProfile();
            ...
            if (data.hasOwnProperty('citableItems')) {
                obj['citableItems'] = JournalProfileCitableItems.constructFromObject(data['citableItems']);
            }
            if (data.hasOwnProperty('citations')) {
                obj['citations'] = JournalProfileCitations.constructFromObject(data['citations']);
            }
            if (data.hasOwnProperty('occurrenceCountries')) {
                obj['occurrenceCountries'] = ApiClient.convertToType(data['occurrenceCountries'], [JournalProfileOccurrenceCountries]);
            }
            if (data.hasOwnProperty('occurrenceOrganizations')) {
                obj['occurrenceOrganizations'] = ApiClient.convertToType(data['occurrenceOrganizations'], [JournalProfileOccurrenceOrganizations]);
            }
        }
        return obj;
    }
 ...
 */
JournalProfile.prototype['startYear'] = undefined;

/**
 * Last year of the profile (equal to the Report year)
 * @member {Number} endYear
 */
JournalProfile.prototype['endYear'] = undefined;

/**
 * @member {module:model/JournalProfileCitableItems} citableItems
 */
JournalProfile.prototype['citableItems'] = undefined;

/**
 * @member {module:model/JournalProfileCitations} citations
 */
JournalProfile.prototype['citations'] = undefined;
 ...
 * @member {Array.<module:model/JournalProfileOccurrenceCountries>} occurrenceCountries
 */
JournalProfile.prototype['occurrenceCountries'] = undefined;

/**
 * Information about of the top 10 organizations that have published materials in this journal in the past three years.
 * @member {Array.<module:model/JournalProfileOccurrenceOrganizations>} occurrenceOrganizations
 */
JournalProfile.prototype['occurrenceOrganizations'] = undefined;
