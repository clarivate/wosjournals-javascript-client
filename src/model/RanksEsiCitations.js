...
/**
 * The RanksEsiCitations model module.
 * @module model/RanksEsiCitations
 * @version 1.0.0
 */
class RanksEsiCitations {
    /**
     * Constructs a new <code>RanksEsiCitations</code>.
     * @alias module:model/RanksEsiCitations
     */
    constructor() { 
        
        RanksEsiCitations.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RanksEsiCitations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RanksEsiCitations} obj Optional instance to populate.
     * @return {module:model/RanksEsiCitations} The populated <code>RanksEsiCitations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RanksEsiCitations();
 ...
 */
RanksEsiCitations.prototype['category'] = undefined;

/**
 * @member {String} edition
 */
RanksEsiCitations.prototype['edition'] = undefined;

/**
 * @member {String} rank
 */
RanksEsiCitations.prototype['rank'] = undefined;

/**
 * @member {String} quartile
 */
RanksEsiCitations.prototype['quartile'] = undefined;
...
export default RanksEsiCitations;
