...
import CategoryReportsJournals from './CategoryReportsJournals';
import CategoryReportsSourceData from './CategoryReportsSourceData';
import Frequency from './Frequency';
import HalfLife from './HalfLife';
import Immediacy from './Immediacy';
import Jif from './Jif';

/**
 * The CategoryReports model module.
 * @module model/CategoryReports
 * @version 1.0.0
 */
class CategoryReports {
    /**
     * Constructs a new <code>CategoryReports</code>.
     * @alias module:model/CategoryReports
     * @param year {Number} 
     */
    constructor(year) { 
        
        CategoryReports.initialize(this, year);
    }
    ...
    /**
     * Constructs a <code>CategoryReports</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoryReports} obj Optional instance to populate.
     * @return {module:model/CategoryReports} The populated <code>CategoryReports</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryReports();

            if (data.hasOwnProperty('year')) {
                obj['year'] = ApiClient.convertToType(data['year'], 'Number');
            }
            if (data.hasOwnProperty('journals')) {
                obj['journals'] = CategoryReportsJournals.constructFromObject(data['journals']);
            }
            if (data.hasOwnProperty('articles')) {
                obj['articles'] = ApiClient.convertToType(data['articles'], 'Number');
            }
            if (data.hasOwnProperty('cites')) {
                obj['cites'] = ApiClient.convertToType(data['cites'], 'Number');
            }
            if (data.hasOwnProperty('jif')) {
                obj['jif'] = Jif.constructFromObject(data['jif']);
            }
            if (data.hasOwnProperty('immediacy')) {
                obj['immediacy'] = Immediacy.constructFromObject(data['immediacy']);
            }
            if (data.hasOwnProperty('halfLife')) {
                obj['halfLife'] = HalfLife.constructFromObject(data['halfLife']);
            }
            if (data.hasOwnProperty('frequency')) {
                obj['frequency'] = Frequency.constructFromObject(data['frequency']);
            }
            if (data.hasOwnProperty('sourceData')) {
                obj['sourceData'] = CategoryReportsSourceData.constructFromObject(data['sourceData']);
            }
            if (data.hasOwnProperty('categoryData')) {
                obj['categoryData'] = CategoryData.constructFromObject(data['categoryData']);
            }
        }
        return obj;
    }
 ...
 * @member {Number} year
 */
CategoryReports.prototype['year'] = undefined;

/**
 * @member {module:model/CategoryReportsJournals} journals
 */
CategoryReports.prototype['journals'] = undefined;

/**
 * @member {Number} articles
 */
CategoryReports.prototype['articles'] = undefined;

/**
 * @member {Number} cites
 */
CategoryReports.prototype['cites'] = undefined;

/**
 * @member {module:model/Jif} jif
 */
CategoryReports.prototype['jif'] = undefined;

/**
 * @member {module:model/Immediacy} immediacy
 */
CategoryReports.prototype['immediacy'] = undefined;

/**
 * @member {module:model/HalfLife} halfLife
 */
CategoryReports.prototype['halfLife'] = undefined;

/**
 * @member {module:model/Frequency} frequency
 */
CategoryReports.prototype['frequency'] = undefined;

/**
 * @member {module:model/CategoryReportsSourceData} sourceData
 */
CategoryReports.prototype['sourceData'] = undefined;

/**
 * @member {module:model/CategoryData} categoryData
 */
CategoryReports.prototype['categoryData'] = undefined;
