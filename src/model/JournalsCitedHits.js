...
/**
 * The JournalsCitedHits model module.
 * @module model/JournalsCitedHits
 * @version 1.0.0
 */
class JournalsCitedHits {
    /**
     * Constructs a new <code>JournalsCitedHits</code>.
     * @alias module:model/JournalsCitedHits
     */
    constructor() { 
        
        JournalsCitedHits.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalsCitedHits</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalsCitedHits} obj Optional instance to populate.
     * @return {module:model/JournalsCitedHits} The populated <code>JournalsCitedHits</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalsCitedHits();
 ...
 */
JournalsCitedHits.prototype['journal'] = undefined;

/**
 * @member {Array.<Object>} citing
 */
JournalsCitedHits.prototype['citing'] = undefined;
...
export default JournalsCitedHits;
