...
/**
 * The HalfLife model module.
 * @module model/HalfLife
 * @version 1.0.0
 */
class HalfLife {
    /**
     * Constructs a new <code>HalfLife</code>.
     * @alias module:model/HalfLife
     */
    constructor() { 
        
        HalfLife.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HalfLife</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HalfLife} obj Optional instance to populate.
     * @return {module:model/HalfLife} The populated <code>HalfLife</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HalfLife();

            if (data.hasOwnProperty('cited')) {
                obj['cited'] = ApiClient.convertToType(data['cited'], 'Number');
            }
            if (data.hasOwnProperty('citing')) {
                obj['citing'] = ApiClient.convertToType(data['citing'], 'Number');
            }
        }
        return obj;
    }
 ...
 * @member {Number} cited
 */
HalfLife.prototype['cited'] = undefined;

/**
 * @member {Number} citing
 */
HalfLife.prototype['citing'] = undefined;
