...
import CategoriesCitingHits from './CategoriesCitingHits';
import Metadata from './Metadata';

/**
 * The CategoriesCiting model module.
 * @module model/CategoriesCiting
 * @version 1.0.0
 */
class CategoriesCiting {
    /**
     * Constructs a new <code>CategoriesCiting</code>.
     * @alias module:model/CategoriesCiting
     */
    constructor() { 
        
        CategoriesCiting.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoriesCiting</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoriesCiting} obj Optional instance to populate.
     * @return {module:model/CategoriesCiting} The populated <code>CategoriesCiting</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoriesCiting();

            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = Metadata.constructFromObject(data['metadata']);
            }
            if (data.hasOwnProperty('hits')) {
                obj['hits'] = ApiClient.convertToType(data['hits'], [CategoriesCitingHits]);
            }
        }
        return obj;
    }
 ...
 */
CategoriesCiting.prototype['metadata'] = undefined;

/**
 * @member {Array.<module:model/CategoriesCitingHits>} hits
 */
CategoriesCiting.prototype['hits'] = undefined;
...
export default CategoriesCiting;
