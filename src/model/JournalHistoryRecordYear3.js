...
/**
 * The JournalHistoryRecordYear3 model module.
 * @module model/JournalHistoryRecordYear3
 * @version 1.0.0
 */
class JournalHistoryRecordYear3 {
    /**
     * Constructs a new <code>JournalHistoryRecordYear3</code>.
     * @alias module:model/JournalHistoryRecordYear3
     */
    constructor() { 
        
        JournalHistoryRecordYear3.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalHistoryRecordYear3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalHistoryRecordYear3} obj Optional instance to populate.
     * @return {module:model/JournalHistoryRecordYear3} The populated <code>JournalHistoryRecordYear3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalHistoryRecordYear3();
 ...
 * @member {Number} start
 */
JournalHistoryRecordYear3.prototype['start'] = undefined;

/**
 * Last year of title
 * @member {Number} end
 */
JournalHistoryRecordYear3.prototype['end'] = undefined;
...
export default JournalHistoryRecordYear3;
