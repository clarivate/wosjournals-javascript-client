...
/**
 * The JournalListRecordJournalCitationReports model module.
 * @module model/JournalListRecordJournalCitationReports
 * @version 1.0.0
 */
class JournalListRecordJournalCitationReports {
    /**
     * Constructs a new <code>JournalListRecordJournalCitationReports</code>.
     * @alias module:model/JournalListRecordJournalCitationReports
     */
    constructor() { 
        
        JournalListRecordJournalCitationReports.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalListRecordJournalCitationReports</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalListRecordJournalCitationReports} obj Optional instance to populate.
     * @return {module:model/JournalListRecordJournalCitationReports} The populated <code>JournalListRecordJournalCitationReports</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalListRecordJournalCitationReports();
 ...
 * @member {Number} year
 */
JournalListRecordJournalCitationReports.prototype['year'] = undefined;

/**
 * Link to the related report
 * @member {String} url
 */
JournalListRecordJournalCitationReports.prototype['url'] = undefined;
...
export default JournalListRecordJournalCitationReports;
