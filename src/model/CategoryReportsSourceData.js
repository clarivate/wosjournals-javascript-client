...
import CategoryReportsSourceDataArticles from './CategoryReportsSourceDataArticles';
import CategoryReportsSourceDataReviews from './CategoryReportsSourceDataReviews';
import SourceDataArticles from './SourceDataArticles';

/**
 * The CategoryReportsSourceData model module.
 * @module model/CategoryReportsSourceData
 * @version 1.0.0
 */
class CategoryReportsSourceData {
    /**
     * Constructs a new <code>CategoryReportsSourceData</code>.
     * Aggregate Source Data counting the number of citable items and the number of cited references in each type of item.
     * @alias module:model/CategoryReportsSourceData
     */
    constructor() { 
        
        CategoryReportsSourceData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoryReportsSourceData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoryReportsSourceData} obj Optional instance to populate.
     * @return {module:model/CategoryReportsSourceData} The populated <code>CategoryReportsSourceData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryReportsSourceData();

            if (data.hasOwnProperty('articles')) {
                obj['articles'] = CategoryReportsSourceDataArticles.constructFromObject(data['articles']);
            }
            if (data.hasOwnProperty('reviews')) {
                obj['reviews'] = CategoryReportsSourceDataReviews.constructFromObject(data['reviews']);
            }
            if (data.hasOwnProperty('other')) {
                obj['other'] = SourceDataArticles.constructFromObject(data['other']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/CategoryReportsSourceDataArticles} articles
 */
CategoryReportsSourceData.prototype['articles'] = undefined;

/**
 * @member {module:model/CategoryReportsSourceDataReviews} reviews
 */
CategoryReportsSourceData.prototype['reviews'] = undefined;

/**
 * @member {module:model/SourceDataArticles} other
 */
CategoryReportsSourceData.prototype['other'] = undefined;
...
export default CategoryReportsSourceData;
