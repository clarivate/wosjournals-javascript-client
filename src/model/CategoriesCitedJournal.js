...
/**
 * The CategoriesCitedJournal model module.
 * @module model/CategoriesCitedJournal
 * @version 1.0.0
 */
class CategoriesCitedJournal {
    /**
     * Constructs a new <code>CategoriesCitedJournal</code>.
     * @alias module:model/CategoriesCitedJournal
     */
    constructor() { 
        
        CategoriesCitedJournal.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoriesCitedJournal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoriesCitedJournal} obj Optional instance to populate.
     * @return {module:model/CategoriesCitedJournal} The populated <code>CategoriesCitedJournal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoriesCitedJournal();
            ...
            if (data.hasOwnProperty('citedJournals')) {
                obj['citedJournals'] = ApiClient.convertToType(data['citedJournals'], 'Number');
            }
        }
        return obj;
    }
 ...
 * @member {String} self
 */
CategoriesCitedJournal.prototype['self'] = undefined;

/**
 * @member {String} name
 */
CategoriesCitedJournal.prototype['name'] = undefined;

/**
 * @member {Number} citedJournals
 */
CategoriesCitedJournal.prototype['citedJournals'] = undefined;
...
export default CategoriesCitedJournal;
