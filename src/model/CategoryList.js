...
import CategoryListRecord from './CategoryListRecord';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hits')) {
                obj['hits'] = ApiClient.convertToType(data['hits'], [CategoryListRecord]);
            }
        }
        return obj;
    }
 ...
 */
CategoryList.prototype['metadata'] = undefined;

/**
 * List of retrieved categories
 * @member {Array.<module:model/CategoryListRecord>} hits
 */
CategoryList.prototype['hits'] = undefined;
