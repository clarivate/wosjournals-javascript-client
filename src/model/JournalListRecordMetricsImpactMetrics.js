...
/**
 * The JournalListRecordMetricsImpactMetrics model module.
 * @module model/JournalListRecordMetricsImpactMetrics
 * @version 1.0.0
 */
class JournalListRecordMetricsImpactMetrics {
    /**
     * Constructs a new <code>JournalListRecordMetricsImpactMetrics</code>.
     * @alias module:model/JournalListRecordMetricsImpactMetrics
     */
    constructor() { 
        
        JournalListRecordMetricsImpactMetrics.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalListRecordMetricsImpactMetrics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalListRecordMetricsImpactMetrics} obj Optional instance to populate.
     * @return {module:model/JournalListRecordMetricsImpactMetrics} The populated <code>JournalListRecordMetricsImpactMetrics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalListRecordMetricsImpactMetrics();

            if (data.hasOwnProperty('jif')) {
                obj['jif'] = ApiClient.convertToType(data['jif'], 'String');
            }
            if (data.hasOwnProperty('jci')) {
                obj['jci'] = ApiClient.convertToType(data['jci'], 'String');
            }
        }
        return obj;
    }
 ...
 * @member {String} jif
 */
JournalListRecordMetricsImpactMetrics.prototype['jif'] = undefined;

/**
 * null
 * @member {String} jci
 */
JournalListRecordMetricsImpactMetrics.prototype['jci'] = undefined;
...
export default JournalListRecordMetricsImpactMetrics;
