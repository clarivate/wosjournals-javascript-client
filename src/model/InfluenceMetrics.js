...
import InfluenceMetricsEigenFactor from './InfluenceMetricsEigenFactor';

/**
 * The InfluenceMetrics model module.
 * @module model/InfluenceMetrics
 * @version 1.0.0
 */
class InfluenceMetrics {
    /**
     * Constructs a new <code>InfluenceMetrics</code>.
     * @alias module:model/InfluenceMetrics
     */
    constructor() { 
        
        InfluenceMetrics.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InfluenceMetrics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InfluenceMetrics} obj Optional instance to populate.
     * @return {module:model/InfluenceMetrics} The populated <code>InfluenceMetrics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InfluenceMetrics();

            if (data.hasOwnProperty('eigenFactor')) {
                obj['eigenFactor'] = InfluenceMetricsEigenFactor.constructFromObject(data['eigenFactor']);
            }
            if (data.hasOwnProperty('articleInfluence')) {
                obj['articleInfluence'] = ApiClient.convertToType(data['articleInfluence'], 'Number');
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InfluenceMetricsEigenFactor} eigenFactor
 */
InfluenceMetrics.prototype['eigenFactor'] = undefined;
 ...
 * @member {Number} articleInfluence
 */
InfluenceMetrics.prototype['articleInfluence'] = undefined;
