...
import JournalsCitesJournal from './JournalsCitesJournal';

/**
 * The JournalsCitingHits model module.
 * @module model/JournalsCitingHits
 * @version 1.0.0
 */
class JournalsCitingHits {
    /**
     * Constructs a new <code>JournalsCitingHits</code>.
     * @alias module:model/JournalsCitingHits
     */
    constructor() { 
        
        JournalsCitingHits.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalsCitingHits</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalsCitingHits} obj Optional instance to populate.
     * @return {module:model/JournalsCitingHits} The populated <code>JournalsCitingHits</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalsCitingHits();

            if (data.hasOwnProperty('journal')) {
                obj['journal'] = JournalsCitesJournal.constructFromObject(data['journal']);
            }
...
/**
 * @member {module:model/JournalsCitesJournal} journal
 */
JournalsCitingHits.prototype['journal'] = undefined;

/**
 * @member {Array.<Object>} cited
 */
JournalsCitingHits.prototype['cited'] = undefined;
...
export default JournalsCitingHits;
