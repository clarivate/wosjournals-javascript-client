...
import CategoriesCitedJournal from './CategoriesCitedJournal';

/**
 * The CategoriesCitedHits model module.
 * @module model/CategoriesCitedHits
 * @version 1.0.0
 */
class CategoriesCitedHits {
    /**
     * Constructs a new <code>CategoriesCitedHits</code>.
     * @alias module:model/CategoriesCitedHits
     */
    constructor() { 
        
        CategoriesCitedHits.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoriesCitedHits</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoriesCitedHits} obj Optional instance to populate.
     * @return {module:model/CategoriesCitedHits} The populated <code>CategoriesCitedHits</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoriesCitedHits();

            if (data.hasOwnProperty('journal')) {
                obj['journal'] = CategoriesCitedJournal.constructFromObject(data['journal']);
            }
            if (data.hasOwnProperty('citing')) {
                obj['citing'] = ApiClient.convertToType(data['citing'], [Object]);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/CategoriesCitedJournal} journal
 */
CategoriesCitedHits.prototype['journal'] = undefined;

/**
 * @member {Array.<Object>} citing
 */
CategoriesCitedHits.prototype['citing'] = undefined;
...
export default CategoriesCitedHits;
