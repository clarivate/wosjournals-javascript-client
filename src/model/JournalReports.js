...
import JournalReportsJournal from './JournalReportsJournal';
import JournalReportsMetrics from './JournalReportsMetrics';
import Ranks from './Ranks';
import SourceData from './SourceData';

/**
 * The JournalReports model module.
 * @module model/JournalReports
 * @version 1.0.0
 */
class JournalReports {
    /**
     * Constructs a new <code>JournalReports</code>.
     * @alias module:model/JournalReports
     */
    constructor() { 
        
        JournalReports.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalReports</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalReports} obj Optional instance to populate.
     * @return {module:model/JournalReports} The populated <code>JournalReports</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalReports();

            if (data.hasOwnProperty('year')) {
                obj['year'] = ApiClient.convertToType(data['year'], 'Number');
            }
            if (data.hasOwnProperty('journal')) {
                obj['journal'] = JournalReportsJournal.constructFromObject(data['journal']);
            }
            if (data.hasOwnProperty('metrics')) {
                obj['metrics'] = JournalReportsMetrics.constructFromObject(data['metrics']);
            }
            if (data.hasOwnProperty('ranks')) {
                obj['ranks'] = Ranks.constructFromObject(data['ranks']);
            }
            if (data.hasOwnProperty('journalData')) {
                obj['journalData'] = JournalData.constructFromObject(data['journalData']);
            }
            if (data.hasOwnProperty('sourceData')) {
                obj['sourceData'] = SourceData.constructFromObject(data['sourceData']);
            }
            if (data.hasOwnProperty('journalProfile')) {
                obj['journalProfile'] = JournalProfile.constructFromObject(data['journalProfile']);
            }
        }
        return obj;
    }
 ...
 * @member {Number} year
 */
JournalReports.prototype['year'] = undefined;

/**
 * @member {module:model/JournalReportsJournal} journal
 */
JournalReports.prototype['journal'] = undefined;

/**
 * @member {module:model/JournalReportsMetrics} metrics
 */
JournalReports.prototype['metrics'] = undefined;

/**
 * @member {module:model/Ranks} ranks
 */
JournalReports.prototype['ranks'] = undefined;

/**
 * @member {module:model/JournalData} journalData
 */
JournalReports.prototype['journalData'] = undefined;

/**
 * @member {module:model/SourceData} sourceData
 */
JournalReports.prototype['sourceData'] = undefined;

/**
 * @member {module:model/JournalProfile} journalProfile
 */
JournalReports.prototype['journalProfile'] = undefined;
