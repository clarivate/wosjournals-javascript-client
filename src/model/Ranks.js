...
import JournalListRecordRanksJci from './JournalListRecordRanksJci';
import RankQuartileData from './RankQuartileData';
import RanksEsiCitations from './RanksEsiCitations';
import RanksJif from './RanksJif';

/**
 * The Ranks model module.
 * @module model/Ranks
 * @version 1.0.0
 */
class Ranks {
    /**
     * Constructs a new <code>Ranks</code>.
     ...
     * @alias module:model/Ranks
     */
    constructor() { 
        
        Ranks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Ranks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ranks} obj Optional instance to populate.
     * @return {module:model/Ranks} The populated <code>Ranks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('jif')) {
                obj['jif'] = ApiClient.convertToType(data['jif'], [RanksJif]);
            }
            if (data.hasOwnProperty('articleInfluence')) {
                obj['articleInfluence'] = ApiClient.convertToType(data['articleInfluence'], [RankQuartileData]);
            }
            if (data.hasOwnProperty('eigenFactorScore')) {
                obj['eigenFactorScore'] = ApiClient.convertToType(data['eigenFactorScore'], [RankQuartileData]);
            }
            if (data.hasOwnProperty('immediacyIndex')) {
                obj['immediacyIndex'] = ApiClient.convertToType(data['immediacyIndex'], [RankQuartileData]);
            }
            if (data.hasOwnProperty('jci')) {
                obj['jci'] = ApiClient.convertToType(data['jci'], [JournalListRecordRanksJci]);
            }
            if (data.hasOwnProperty('esiCitations')) {
                obj['esiCitations'] = ApiClient.convertToType(data['esiCitations'], [RanksEsiCitations]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/RanksJif>} jif
 */
Ranks.prototype['jif'] = undefined;

/**
 * @member {Array.<module:model/RankQuartileData>} articleInfluence
 */
Ranks.prototype['articleInfluence'] = undefined;

/**
 * @member {Array.<module:model/RankQuartileData>} eigenFactorScore
 */
Ranks.prototype['eigenFactorScore'] = undefined;

/**
 * @member {Array.<module:model/RankQuartileData>} immediacyIndex
 */
Ranks.prototype['immediacyIndex'] = undefined;

/**
 * @member {Array.<module:model/JournalListRecordRanksJci>} jci
 */
Ranks.prototype['jci'] = undefined;

/**
 * @member {Array.<module:model/RanksEsiCitations>} esiCitations
 */
Ranks.prototype['esiCitations'] = undefined;
