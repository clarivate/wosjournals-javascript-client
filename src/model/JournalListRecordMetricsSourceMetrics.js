...
/**
 * The JournalListRecordMetricsSourceMetrics model module.
 * @module model/JournalListRecordMetricsSourceMetrics
 * @version 1.0.0
 */
class JournalListRecordMetricsSourceMetrics {
    /**
     * Constructs a new <code>JournalListRecordMetricsSourceMetrics</code>.
     * @alias module:model/JournalListRecordMetricsSourceMetrics
     */
    constructor() { 
        
        JournalListRecordMetricsSourceMetrics.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalListRecordMetricsSourceMetrics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalListRecordMetricsSourceMetrics} obj Optional instance to populate.
     * @return {module:model/JournalListRecordMetricsSourceMetrics} The populated <code>JournalListRecordMetricsSourceMetrics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalListRecordMetricsSourceMetrics();
 ...
 */
JournalListRecordMetricsSourceMetrics.prototype['jifPercentile'] = undefined;
...
export default JournalListRecordMetricsSourceMetrics;
