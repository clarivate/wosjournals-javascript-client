...
/**
 * The JournalProfileCitations model module.
 * @module model/JournalProfileCitations
 * @version 1.0.0
 */
class JournalProfileCitations {
    /**
     * Constructs a new <code>JournalProfileCitations</code>.
     ...
     * @alias module:model/JournalProfileCitations
     */
    constructor() { 
        
        JournalProfileCitations.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalProfileCitations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalProfileCitations} obj Optional instance to populate.
     * @return {module:model/JournalProfileCitations} The populated <code>JournalProfileCitations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalProfileCitations();

            if (data.hasOwnProperty('goldOA')) {
                obj['goldOA'] = ApiClient.convertToType(data['goldOA'], 'Number');
            }
...
/**
 * @member {Number} goldOA
 */
JournalProfileCitations.prototype['goldOA'] = undefined;

/**
 * @member {Number} subscription
 */
JournalProfileCitations.prototype['subscription'] = undefined;

/**
 * @member {Number} other
 */
JournalProfileCitations.prototype['other'] = undefined;

/**
 * @member {Number} unlinked
 */
JournalProfileCitations.prototype['unlinked'] = undefined;
...
export default JournalProfileCitations;
