...
/**
 * The ImpactMetrics model module.
 * @module model/ImpactMetrics
 * @version 1.0.0
 */
class ImpactMetrics {
    /**
     * Constructs a new <code>ImpactMetrics</code>.
     * @alias module:model/ImpactMetrics
     */
    constructor() { 
        
        ImpactMetrics.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImpactMetrics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImpactMetrics} obj Optional instance to populate.
     * @return {module:model/ImpactMetrics} The populated <code>ImpactMetrics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImpactMetrics();

            if (data.hasOwnProperty('totalCites')) {
                obj['totalCites'] = ApiClient.convertToType(data['totalCites'], 'Number');
            }
            if (data.hasOwnProperty('jif')) {
                obj['jif'] = ApiClient.convertToType(data['jif'], 'String');
            }
            if (data.hasOwnProperty('jifWithoutSelfCitations')) {
                obj['jifWithoutSelfCitations'] = ApiClient.convertToType(data['jifWithoutSelfCitations'], 'String');
            }
            if (data.hasOwnProperty('jif5Years')) {
                obj['jif5Years'] = ApiClient.convertToType(data['jif5Years'], 'Number');
            }
            if (data.hasOwnProperty('immediacyIndex')) {
                obj['immediacyIndex'] = ApiClient.convertToType(data['immediacyIndex'], 'Number');
            }
            if (data.hasOwnProperty('jci')) {
                obj['jci'] = ApiClient.convertToType(data['jci'], 'Number');
            }
        }
        return obj;
    }
 ...
 * @member {Number} totalCites
 */
ImpactMetrics.prototype['totalCites'] = undefined;
 ...
 * @member {String} jif
 */
ImpactMetrics.prototype['jif'] = undefined;

/**
 * Journal Impact Factor without self cites.
 * @member {String} jifWithoutSelfCitations
 */
ImpactMetrics.prototype['jifWithoutSelfCitations'] = undefined;

/**
 * Average number of times articles from the journal published in the past five years have been cited in the JCR year
 * @member {Number} jif5Years
 */
ImpactMetrics.prototype['jif5Years'] = undefined;
 ...
 * @member {Number} immediacyIndex
 */
ImpactMetrics.prototype['immediacyIndex'] = undefined;
 ...
 * @member {Number} jci
 */
ImpactMetrics.prototype['jci'] = undefined;
