...
import JournalHistoryRecordYear1 from './JournalHistoryRecordYear1';

/**
 * The JournalHistoryRecordIssn model module.
 * @module model/JournalHistoryRecordIssn
 * @version 1.0.0
 */
class JournalHistoryRecordIssn {
    /**
     * Constructs a new <code>JournalHistoryRecordIssn</code>.
     * @alias module:model/JournalHistoryRecordIssn
     */
    constructor() { 
        
        JournalHistoryRecordIssn.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalHistoryRecordIssn</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalHistoryRecordIssn} obj Optional instance to populate.
     * @return {module:model/JournalHistoryRecordIssn} The populated <code>JournalHistoryRecordIssn</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalHistoryRecordIssn();

            if (data.hasOwnProperty('issn')) {
                obj['issn'] = ApiClient.convertToType(data['issn'], 'String');
            }
            if (data.hasOwnProperty('year')) {
                obj['year'] = JournalHistoryRecordYear1.constructFromObject(data['year']);
            }
        }
        return obj;
    }
 ...
 * @member {String} issn
 */
JournalHistoryRecordIssn.prototype['issn'] = undefined;

/**
 * @member {module:model/JournalHistoryRecordYear1} year
 */
JournalHistoryRecordIssn.prototype['year'] = undefined;
...
export default JournalHistoryRecordIssn;
