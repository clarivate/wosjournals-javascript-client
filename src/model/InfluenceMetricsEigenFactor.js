...
/**
 * The InfluenceMetricsEigenFactor model module.
 * @module model/InfluenceMetricsEigenFactor
 * @version 1.0.0
 */
class InfluenceMetricsEigenFactor {
    /**
     * Constructs a new <code>InfluenceMetricsEigenFactor</code>.
     ...
     * @alias module:model/InfluenceMetricsEigenFactor
     */
    constructor() { 
        
        InfluenceMetricsEigenFactor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InfluenceMetricsEigenFactor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InfluenceMetricsEigenFactor} obj Optional instance to populate.
     * @return {module:model/InfluenceMetricsEigenFactor} The populated <code>InfluenceMetricsEigenFactor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InfluenceMetricsEigenFactor();

            if (data.hasOwnProperty('score')) {
                obj['score'] = ApiClient.convertToType(data['score'], 'Number');
            }
            if (data.hasOwnProperty('normalized')) {
                obj['normalized'] = ApiClient.convertToType(data['normalized'], 'Number');
            }
        }
        return obj;
    }
 ...
 * @member {Number} score
 */
InfluenceMetricsEigenFactor.prototype['score'] = undefined;
 ...
 * @member {Number} normalized
 */
InfluenceMetricsEigenFactor.prototype['normalized'] = undefined;
...
export default InfluenceMetricsEigenFactor;
