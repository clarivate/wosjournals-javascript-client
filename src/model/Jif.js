...
import JifAggregate from './JifAggregate';

/**
 * The Jif model module.
 * @module model/Jif
 * @version 1.0.0
 */
class Jif {
    /**
     * Constructs a new <code>Jif</code>.
     * @alias module:model/Jif
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Jif</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Jif} obj Optional instance to populate.
     * @return {module:model/Jif} The populated <code>Jif</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('aggregate')) {
                obj['aggregate'] = JifAggregate.constructFromObject(data['aggregate']);
            }
        }
        return obj;
    }
 ...
 */
Jif.prototype['median'] = undefined;

/**
 * @member {module:model/JifAggregate} aggregate
 */
Jif.prototype['aggregate'] = undefined;
