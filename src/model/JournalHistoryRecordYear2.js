...
/**
 * The JournalHistoryRecordYear2 model module.
 * @module model/JournalHistoryRecordYear2
 * @version 1.0.0
 */
class JournalHistoryRecordYear2 {
    /**
     * Constructs a new <code>JournalHistoryRecordYear2</code>.
     * @alias module:model/JournalHistoryRecordYear2
     */
    constructor() { 
        
        JournalHistoryRecordYear2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalHistoryRecordYear2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalHistoryRecordYear2} obj Optional instance to populate.
     * @return {module:model/JournalHistoryRecordYear2} The populated <code>JournalHistoryRecordYear2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalHistoryRecordYear2();
 ...
 * @member {Number} start
 */
JournalHistoryRecordYear2.prototype['start'] = undefined;

/**
 * Last year of name, address, and country/region
 * @member {Number} end
 */
JournalHistoryRecordYear2.prototype['end'] = undefined;
...
export default JournalHistoryRecordYear2;
