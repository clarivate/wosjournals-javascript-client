...
import CitedData from './CitedData';
import CitingData from './CitingData';

/**
 * The JournalData model module.
 * @module model/JournalData
 * @version 1.0.0
 */
class JournalData {
    /**
     * Constructs a new <code>JournalData</code>.
     * Links to the Cited and Citing endpoints, with the total count of records.
     * @alias module:model/JournalData
     */
    constructor() { 
        
        JournalData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalData} obj Optional instance to populate.
     * @return {module:model/JournalData} The populated <code>JournalData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalData();

            if (data.hasOwnProperty('cited')) {
                obj['cited'] = CitedData.constructFromObject(data['cited']);
            }
            if (data.hasOwnProperty('citing')) {
                obj['citing'] = CitingData.constructFromObject(data['citing']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/CitedData} cited
 */
JournalData.prototype['cited'] = undefined;

/**
 * @member {module:model/CitingData} citing
 */
JournalData.prototype['citing'] = undefined;
