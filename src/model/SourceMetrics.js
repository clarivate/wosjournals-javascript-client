...
import SourceMetricsCitableItems from './SourceMetricsCitableItems';

/**
 * The SourceMetrics model module.
 * @module model/SourceMetrics
 * @version 1.0.0
 */
class SourceMetrics {
    /**
     * Constructs a new <code>SourceMetrics</code>.
     * @alias module:model/SourceMetrics
     */
    constructor() { 
        
        SourceMetrics.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SourceMetrics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SourceMetrics} obj Optional instance to populate.
     * @return {module:model/SourceMetrics} The populated <code>SourceMetrics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SourceMetrics();

            if (data.hasOwnProperty('citableItems')) {
                obj['citableItems'] = SourceMetricsCitableItems.constructFromObject(data['citableItems']);
            }
            if (data.hasOwnProperty('jifPercentile')) {
                obj['jifPercentile'] = ApiClient.convertToType(data['jifPercentile'], 'Number');
            }
...
/**
 * @member {module:model/SourceMetricsCitableItems} citableItems
 */
SourceMetrics.prototype['citableItems'] = undefined;
 ...
 * @member {Number} jifPercentile
 */
SourceMetrics.prototype['jifPercentile'] = undefined;

/**
 * @member {module:model/HalfLife} halfLife
 */
SourceMetrics.prototype['halfLife'] = undefined;
