...
/**
 * The CategoriesCitingJournal model module.
 * @module model/CategoriesCitingJournal
 * @version 1.0.0
 */
class CategoriesCitingJournal {
    /**
     * Constructs a new <code>CategoriesCitingJournal</code>.
     * @alias module:model/CategoriesCitingJournal
     */
    constructor() { 
        
        CategoriesCitingJournal.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoriesCitingJournal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoriesCitingJournal} obj Optional instance to populate.
     * @return {module:model/CategoriesCitingJournal} The populated <code>CategoriesCitingJournal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoriesCitingJournal();
            ...
            if (data.hasOwnProperty('citingJournals')) {
                obj['citingJournals'] = ApiClient.convertToType(data['citingJournals'], 'Number');
            }
        }
        return obj;
    }
 ...
 * @member {String} self
 */
CategoriesCitingJournal.prototype['self'] = undefined;

/**
 * @member {String} name
 */
CategoriesCitingJournal.prototype['name'] = undefined;

/**
 * @member {Number} citingJournals
 */
CategoriesCitingJournal.prototype['citingJournals'] = undefined;
...
export default CategoriesCitingJournal;
