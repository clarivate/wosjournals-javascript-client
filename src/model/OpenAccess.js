...
/**
 * The OpenAccess model module.
 * @module model/OpenAccess
 * @version 1.0.0
 */
class OpenAccess {
    /**
     * Constructs a new <code>OpenAccess</code>.
     * Journal open access status
     * @alias module:model/OpenAccess
     */
    constructor() { 
        
        OpenAccess.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OpenAccess</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OpenAccess} obj Optional instance to populate.
     * @return {module:model/OpenAccess} The populated <code>OpenAccess</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OpenAccess();
 ...
 */
OpenAccess.prototype['startYear'] = undefined;

/**
 * Last year of journal open access
 * @member {Number} endYear
 */
OpenAccess.prototype['endYear'] = undefined;
