...
/**
 * The Immediacy model module.
 * @module model/Immediacy
 * @version 1.0.0
 */
class Immediacy {
    /**
     * Constructs a new <code>Immediacy</code>.
     * @alias module:model/Immediacy
     */
    constructor() { 
        
        Immediacy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Immediacy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Immediacy} obj Optional instance to populate.
     * @return {module:model/Immediacy} The populated <code>Immediacy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Immediacy();

            if (data.hasOwnProperty('count')) {
                obj['count'] = ApiClient.convertToType(data['count'], 'Number');
            }
            if (data.hasOwnProperty('citesCurrentYear')) {
                obj['citesCurrentYear'] = ApiClient.convertToType(data['citesCurrentYear'], 'Number');
            }
            if (data.hasOwnProperty('publishedCurrentYear')) {
                obj['publishedCurrentYear'] = ApiClient.convertToType(data['publishedCurrentYear'], 'Number');
            }
        }
        return obj;
    }
 ...
 * @member {Number} count
 */
Immediacy.prototype['count'] = undefined;

/**
 * @member {Number} citesCurrentYear
 */
Immediacy.prototype['citesCurrentYear'] = undefined;

/**
 * @member {Number} publishedCurrentYear
 */
Immediacy.prototype['publishedCurrentYear'] = undefined;
