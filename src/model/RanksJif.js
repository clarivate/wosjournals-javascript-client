...
/**
 * The RanksJif model module.
 * @module model/RanksJif
 * @version 1.0.0
 */
class RanksJif {
    /**
     * Constructs a new <code>RanksJif</code>.
     * @alias module:model/RanksJif
     */
    constructor() { 
        
        RanksJif.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RanksJif</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RanksJif} obj Optional instance to populate.
     * @return {module:model/RanksJif} The populated <code>RanksJif</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RanksJif();
 ...
 */
RanksJif.prototype['category'] = undefined;

/**
 * @member {String} edition
 */
RanksJif.prototype['edition'] = undefined;

/**
 * @member {String} self
 */
RanksJif.prototype['self'] = undefined;

/**
 * @member {String} rank
 */
RanksJif.prototype['rank'] = undefined;

/**
 * @member {String} quartile
 */
RanksJif.prototype['quartile'] = undefined;

/**
 * @member {Number} jifPercentile
 */
RanksJif.prototype['jifPercentile'] = undefined;
