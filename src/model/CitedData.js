...
/**
 * The CitedData model module.
 * @module model/CitedData
 * @version 1.0.0
 */
class CitedData {
    /**
     * Constructs a new <code>CitedData</code>.
     * @alias module:model/CitedData
     */
    constructor() { 
        
        CitedData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CitedData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CitedData} obj Optional instance to populate.
     * @return {module:model/CitedData} The populated <code>CitedData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CitedData();
 ...
 * @member {String} url
 */
CitedData.prototype['url'] = undefined;

/**
 * Number of cited journals
 * @member {Number} count
 */
CitedData.prototype['count'] = undefined;
