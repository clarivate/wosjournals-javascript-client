...
/**
 * The SourceDataArticles model module.
 * @module model/SourceDataArticles
 * @version 1.0.0
 */
class SourceDataArticles {
    /**
     * Constructs a new <code>SourceDataArticles</code>.
     * @alias module:model/SourceDataArticles
     */
    constructor() { 
        
        SourceDataArticles.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SourceDataArticles</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SourceDataArticles} obj Optional instance to populate.
     * @return {module:model/SourceDataArticles} The populated <code>SourceDataArticles</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SourceDataArticles();
 ...
 * @member {Number} count
 */
SourceDataArticles.prototype['count'] = undefined;

/**
 * @member {Number} references
 */
SourceDataArticles.prototype['references'] = undefined;
