    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('articles')) {
                obj['articles'] = SourceDataArticles.constructFromObject(data['articles']);
            }
            if (data.hasOwnProperty('reviews')) {
                obj['reviews'] = SourceDataArticles.constructFromObject(data['reviews']);
            }
...
/**
 * @member {module:model/SourceDataArticles} articles
 */
SourceData.prototype['articles'] = undefined;

/**
 * @member {module:model/SourceDataArticles} reviews
 */
SourceData.prototype['reviews'] = undefined;

/**
 * @member {module:model/SourceDataArticles} other
 */
SourceData.prototype['other'] = undefined;
