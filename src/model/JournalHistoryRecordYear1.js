...
/**
 * The JournalHistoryRecordYear1 model module.
 * @module model/JournalHistoryRecordYear1
 * @version 1.0.0
 */
class JournalHistoryRecordYear1 {
    /**
     * Constructs a new <code>JournalHistoryRecordYear1</code>.
     * @alias module:model/JournalHistoryRecordYear1
     */
    constructor() { 
        
        JournalHistoryRecordYear1.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalHistoryRecordYear1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalHistoryRecordYear1} obj Optional instance to populate.
     * @return {module:model/JournalHistoryRecordYear1} The populated <code>JournalHistoryRecordYear1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalHistoryRecordYear1();
 ...
 * @member {Number} start
 */
JournalHistoryRecordYear1.prototype['start'] = undefined;

/**
 * Last year of ISSN
 * @member {Number} end
 */
JournalHistoryRecordYear1.prototype['end'] = undefined;
...
export default JournalHistoryRecordYear1;
