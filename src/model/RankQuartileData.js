...
/**
 * The RankQuartileData model module.
 * @module model/RankQuartileData
 * @version 1.0.0
 */
class RankQuartileData {
    /**
     * Constructs a new <code>RankQuartileData</code>.
     * @alias module:model/RankQuartileData
     */
    constructor() { 
        
        RankQuartileData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RankQuartileData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RankQuartileData} obj Optional instance to populate.
     * @return {module:model/RankQuartileData} The populated <code>RankQuartileData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RankQuartileData();
 ...
 */
RankQuartileData.prototype['category'] = undefined;

/**
 * @member {String} edition
 */
RankQuartileData.prototype['edition'] = undefined;

/**
 * @member {String} self
 */
RankQuartileData.prototype['self'] = undefined;

/**
 * @member {String} rank
 */
RankQuartileData.prototype['rank'] = undefined;

/**
 * @member {String} quartile
 */
RankQuartileData.prototype['quartile'] = undefined;
...
export default RankQuartileData;
