...
export default class JournalsApi {
    ...
    */
     ...
     * @param {Number} opts.jcrYear Filter by Journal Citation Report year (from 1997).  **NOTE:** The filter **jcrYear** is mandatory while using **jif**, **jifPercentile**, and **jifQuartile** filters  Only one value is allowed.
     * @param {String} opts.jif Filter by [Journal Impact Factor](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor28) (JIF).  **NOTE:** The filter **jcrYear** is mandatory while using **jif** filter  Filter logic is described in the section [Filter by range](#range)
    ...
    journalsGet(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/journals', 'GET',
        pathParams, queryParams, this.extraHeaderParams, formParams, postBody,
